<%-- 
    Document   : SI2InspectorPoliceNominationForm
    Created on : 8 Apr, 2022, 11:34:00 AM
    Author     : Manisha
--%>
        ...
        <script type="text/javascript">
            ...
            function validateForm() {
                ...
                if ($("#gradeSerialNo").val() == '') {
                    alert('grade Serial No can not be blank.');
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2">
                                    <label for="qualification"> d) Educational Qualification<span style="color: red">*</span></label>
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2">
                                    <label for="homeDistrict">  e) Home District<span style="color: red">*</span> </label>
                                </div>
                                <div class="col-lg-2">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2">
                                    <label for="postingPlace">f) Present Place of Posting<span style="color: red">*</span> </label>
                                </div>
                                ...
                                <div class="col-lg-2">
                                    <label for="postingUnintDoj">g) Date of joining (in Present Place of Posting)<span style="color: red">*</span></label>
                                </div>
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-3">
                                    <c:if test="${not empty nominationForm.originalFileNamePunishment}">
                                        ...
                                        <c:if test="${empty nominationForm.originalFileNamePunishment}">
                                        <input type="file" name="punishmentCopy"  id="punishmentCopy"/> <span style="color:red">(Only PDF)</span>
                                    </c:if>
                                </div>
