<%-- 
    Document   : NominationViewForSubInspector2InspectorPolice
    Created on : 18 Nov, 2021, 4:32:58 PM
    Author     : Manisha
--%>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2">
                                    <label for="postingPlace">f) Unit of Posting </label>
                                </div>
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2">
                                    <form:select path="presentRank" id="presentRank" class="form-control">  
                                        <c:if test="${nominationForm.sltNominationForPost eq '140126'}">
                                            <form:option value="141191">SUB INSPECTOR OF POLICE(ARMED)</form:option>
                                        </c:if>
                                        <c:if test="${nominationForm.sltNominationForPost eq '140871'}"> 
                                            <form:option value="140871">INSPECTOR OF POLICE(ARMED)</form:option>
                                        </c:if>
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-3">
                                    <form:select path="adverseIfany" id="adverseIfany" class="form-control" onclick="toggleCCROLLDiv()">
                                        <form:option value=""> --Select One-- </form:option>
                                        <form:option value="No"> No </form:option>
                                        <form:option value="Yes"> Yes </form:option>
                                    </form:select>
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2">
                                    <label for="dpcifany"> Departmental/ Disciplinary Proceedings/ Vigilance Enquiry/ Criminal Cases / HRPC Cases, if any, Pending initiated   </label>
                                </div>
                                <div class="col-lg-3">
