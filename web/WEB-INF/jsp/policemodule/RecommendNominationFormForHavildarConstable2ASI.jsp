<%-- 
    Document   : RecommendNominationFormForHavildarConstable2ASI
    Created on : 5 Sep, 2022, 5:04:07 PM
    Author     : Manisha
--%>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2">
                                    <form:input path="postingPlace" id="postingPlace"  placeholder="Place" class="form-control" readonly="true"/>  
                                </div>
                                <div class="col-lg-2">
                                ...
                                <div class="col-lg-2">
                                    <form:input path="postingUnintDoj" id="postingUnintDoj" placeholder="DD/MM/YYYY" class="form-control" readonly="true"/>  
                                </div>
                            </div>
                            <div class="row" style="margin-bottom: 7px;">
                                <div class="col-lg-1">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2">
                                    <form:input path="passingPlaceForConstableTraining" id="passingPlaceForConstableTraining"  placeholder="Place" class="form-control" readonly="true"/>  

                                </div>
                                <div class="col-lg-2">
                                    <form:input path="passingYearFromForConstableTraining" id="passingYearFromForConstableTraining" placeholder="DD/MM/YYYY" class="form-control" readonly="true"/> 
                                </div>
                                <div class="col-lg-2">
                                    <form:input path="passingYearToForConstableTraining" id="passingYearToForConstableTraining" placeholder="DD/MM/YYYY" class="form-control" readonly="true"/> 
                                </div>
                            </div>
                            <div class="row" style="margin-bottom: 7px;">
                                <div class="col-lg-1">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2">
                                    <form:input path="orderNopassingForConstableTraining" id="orderNopassingForConstableTraining" class="form-control" readonly="true"/> 

                                </div>
                                <div class="col-lg-2">
                                    <form:input path="orderDatepassingForConstableTraining" id="orderDatepassingForConstableTraining" placeholder="DD/MM/YYYY" class="form-control" readonly="true"/> 
                                </div>
                                <div class="col-lg-2">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-4">
                                    <form:select path="physicalFitness" id="physicalFitness" class="form-control" readonly="true">
                            ...
                            <c:if test="${nominationForm.sltpostName eq '140858'}">
                                <div class="row" style="margin-bottom: 7px;">
                                    ...
                                    <div class="col-lg-3">
                                        <form:select path="physicalFitnessDocumentStatus" id="physicalFitnessDocumentStatus" class="form-control" readonly="true">
                                            <form:option value=""> --Select One-- </form:option>
