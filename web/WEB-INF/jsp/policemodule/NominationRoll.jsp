<%-- 
    Document   : NominationRoll
    Created on : 16 Oct, 2020, 3:26:37 PM
    Author     : Surendra
--%>
                        ...
                        <div class="panel-body">
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <form:select path="sltpostName" id="sltpostName" class="form-control" onclick="getNominationRankList(this)">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="5%" style="text-align: center">
                                                        <c:if test="${obj.submittedStatusForFieldOffice ne 'Y'}">
                                                            <a href="editNominationroll.htm?nominationMasterId=${obj.nominationMasterId}&fiscalyear=${obj.fiscalyear}" title="Click to Edit"><i class="fa fa-pencil-square-o  fa-2x"></i>
                                                            </a>
                                                        </c:if>
