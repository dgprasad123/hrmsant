            ...
            <form:form action="recommendAwardByRangeForm.htm" commandName="AwardMedalListForm">
                ...
                <div id="page-wrapper">
                    <div class="panel panel-default">
                        <h3 style="text-align:center">RECOMMENDATION FOR THE AWARD OF PRESIDENT'S POLICE MEDAL FOR DISTINGUISHED SERVICE/POLICE MEDAL FOR MERITORIOUS SERVICE ON THE OCCASION OF REPUBLIC DAY - 2024</h3>
                        ...
                        <div class="panel-heading">
                            <a href="awardormedalListForRangeOffice.htm?awardMedalTypeId=${AwardMedalListForm.awardMedalTypeId}&awardYear=${AwardMedalListForm.awardYear}">
                        ...
                        <div class ="panel-body">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2">
                                    <label for="dob"> As on 26.01.2024 </label>
                                </div>
                                <div class="col-lg-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <label for="initialAppointYear"> Total Police Service<br />(As on 26.01.2024) </label>
                                </div>
                                <div class="col-lg-2">
                                    ...
                                    <table border="0" width="100%">
                                        ...
                                        <tr>
                                            <td rowspan="13" width="60%">
                                                [2012-2013 to 2021 - 2022]<br /> In case of maximum 3 NIC,ACR grading for last 13 years*.<br />
                                                [2009-2010 to 2021-2022]<br />Similarly, in case ACR is given as per Calendar year,<br />
                                                [2008-2021]<br />O.S. –Outstanding, V.G. – Very Good, G.- Good, A.V.-Average,<br />
