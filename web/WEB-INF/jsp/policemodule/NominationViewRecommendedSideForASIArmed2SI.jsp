<%-- 
    Document   : NominationViewRecommendedSideForASIArmed2SI
    Created on : 28 Dec, 2022, 5:35:07 PM
    Author     : Manisha
--%>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2">
                                    <label>i) i) Whether Filed up to date Property Statement/Not <span style="color: red">*</span></label>
                                </div>
                                <div class="col-lg-2">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-6">
                                    <form:textarea path="viewOfRecommendingAuthority" id="viewOfRecommendingAuthority" class="form-control" rows="4" cols="100"  maxlength="450" readonly="true"/>
                                </div>
