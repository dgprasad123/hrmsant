    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <form:form action="createNominationrollDG.htm" commandName="EmpDetNom">
                    <form:hidden path="nominationMasterId"/>
                    <div class="panel panel-default">
                        <h3 style="text-align:center"> Nomination Detail Employee List</h3>

                        <div class="panel-heading">
                            <a href="NominatedList.htm"><input type="button" class="btn btn-primary" value="Back"/></a> 
                                                    ...
                                                    <c:forEach items="${empList}" var="emp" varStatus="counter">
                                                        <tr>
                                                            ...
                                                            <td width="10%" style="text-align: center">
                                                                <a title="Click for Remarks" href="remarksFormController.htm?nominationMasterId=${emp.nominationMasterId}&nominationDetailId=${emp.nominationDetailId}"><i class="fa fa-pencil-square-o  fa-2x"></i></a>
                                                            </td>
                                                            <td width="10%" style="text-align: center">
