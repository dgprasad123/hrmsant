<%-- 
    Document   : ShowProposedNominatioListByRangeOffice
                                                    ...
                                                    <c:forEach items="${empList}" var="emp" varStatus="counter">
                                                        <tr>
                                                            ...
                                                            <td width="10%" style="text-align: center">
                                                                <a href="EmployeeNominationViewControllerForRange.htm?nominationMasterId=${emp.nominationMasterId}&nominationDetailId=${emp.nominationDetailId}">View</a>
                                                            </td>
                                                            <td width="10%" style="text-align: center">
                                                                <a href="downloadNominationFormByRecommend.htm?nominationMasterId=${emp.nominationMasterId}&nominationDetailId=${emp.nominationDetailId}"><i class="fa fa-file-pdf-o  fa-2x"></i></a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
