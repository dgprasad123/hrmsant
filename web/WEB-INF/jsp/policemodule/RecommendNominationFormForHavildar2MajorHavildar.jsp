<%-- 
    Document   : RecommendNominationFormForHavildar2MajorHavildar
    Created on : 7 Nov, 2022, 11:03:08 AM
    Author     : Manisha
--%>
        ...
        <script type="text/javascript">
            ...
            function validateForm() {
                if ($("#recommendStatus").val() == '') {
                    alert('Please select Recommendation Status From Recommending Authority.');
