<%-- 
    Document   : RecommendPageforDGPolice
    Created on : 8 Dec, 2020, 11:20:18 AM
    Author     : Surendra
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function getNominationForAllRankListJSON(obj) {
                var sltpostName = obj.value;
                if (sltpostName != '') {
                    $('#sltNominationForPost').empty();
                    var url = 'getNominationForAllRankListJSON.htm?sltpostName=' + sltpostName;
                    $('#sltNominationForPost').append('<option value="">--Select--</option>');
                    $.getJSON(url, function(data) {
                        $.each(data, function(i, obj) {
                            $('#sltNominationForPost').append('<option value="' + obj.value + '">' + obj.label + '</option>');
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <form:select path="sltpostName" id="sltpostName" class="form-control" onclick="getNominationForAllRankListJSON(this)">
                            ...
                            <div class="row" style="margin-bottom: 7px;" id="actionDivId">
                                <div class="col-lg-2">
                                    <label for="sltCadre"> Select Cadre <span style="color: red">*</span></label>
                                </div>
                                <div class="col-lg-8">
                                    <form:select path="cadreName" id="cadreName" class="form-control">
