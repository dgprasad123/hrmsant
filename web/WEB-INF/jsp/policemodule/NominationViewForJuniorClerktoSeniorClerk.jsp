<%-- 
    Document   : NominationViewForJuniorClerktoSeniorClerk
    Created on : 1 Feb, 2022, 4:10:29 PM
    Author     : Manisha
--%>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                ...
                                <c:if test="${not empty nominationForm.differentDistrictandEstablishmentList}">
                                    <c:forEach items="${nominationForm.differentDistrictandEstablishmentList}" var="dlist"> 
                                        <div class="row" style="margin-bottom: 10px;">
                                            ...
                                            <div class="col-lg-2">
                                                <input type="text" name="postingOrDeputationInOtherDistrictFromDate" id="postingOrDeputationInOtherDistrictFromDate0" value="${dlist.districtFromDate}" class="form-control txtDate"/>
                                            </div>
                                            <div class="col-lg-1">
                                                <input type="text" name="postingOrDeputationInOtherDistrictToDate" id="postingOrDeputationInOtherDistrictFromDate0" value="${dlist.districtToDate}" class="form-control txtDate"/>
                                            </div>
                                        </div>
                                    </c:forEach>
                                </c:if> 
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="rewardGSMarkPrior" id="rewardGSMarkPrior" class="form-control" maxlength="10" readonly="true"/>
                                </div>
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="rewardGSMarkDuring" id="rewardGSMarkDuring" class="form-control" maxlength="10" readonly="true"/>
                                </div>
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="rewardGSMarkFrom" id="rewardGSMarkFrom" class="form-control" maxlength="10" readonly="true"/>
                                </div>
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="rewardMoneyOherPrior" id="rewardMoneyOherPrior" class="form-control" maxlength="10" readonly="true"/>
                                </div>
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="rewardMoneyOherDuring" id="rewardMoneyOherDuring" class="form-control" maxlength="10" readonly="true"/>
                                </div>
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="rewardMoneyOherFrom" id="rewardMoneyOherFrom" class="form-control" maxlength="10" readonly="true"/>
                                </div>
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="rewardMedalsPrior" id="rewardMedalsPrior" class="form-control" maxlength="10" readonly="true"/>
                                </div>
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="rewardMedalsDuring" id="rewardMedalsDuring" class="form-control" maxlength="10" readonly="true"/>
                                </div>
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="rewardMedalsFrom" id="rewardMedalsFrom" class="form-control" maxlength="10" readonly="true"/>
                                </div>
                            </div>
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="punishmentMajorPrior" id="punishmentMajorPrior" class="form-control" maxlength="10" readonly="true"/>
                                </div>
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="punishmentMajorDuring" id="punishmentMajorDuring" class="form-control" maxlength="10" readonly="true"/>
                                </div>
                                <div class="col-lg-2" style="text-align: center">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="punishmentMinorPrior" id="punishmentMinorPrior" class="form-control" maxlength="10" readonly="true"/>
                                </div>
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="punishmentMinorDuring" id="punishmentMinorDuring" class="form-control" maxlength="10" readonly="true"/>
                                </div>
                                <div class="col-lg-2" style="text-align: center">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-6">
                                    <form:textarea path="powerOfDecissionMaking" id="powerOfDecissionMaking" class="form-control" rows="4" cols="100" maxlength="1000" readonly="true"/>
                                </div>
                            </div>
                            <div class="row" style="margin-bottom: 7px;">
                                <div class="col-lg-1">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-6">
                                    <form:textarea path="adverseDetail" id="adverseDetail" class="form-control" rows="4" cols="100" maxlength="450" readonly="true"/>
                                </div>
