<%-- 
    Document   : RecommendNominationFormForHavildar2SIPolice
    Created on : 17 Nov, 2021, 3:38:58 PM
    Author     : Manisha
--%>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-6">
                                    <form:textarea path="viewOfRecommendingAuthority" id="viewOfRecommendingAuthority" class="form-control" rows="4" cols="100"  maxlength="450"/>
                                </div>
