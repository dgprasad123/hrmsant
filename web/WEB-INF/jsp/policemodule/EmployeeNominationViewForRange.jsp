<%-- 
    Document   : EmployeeNominationViewForRange
    Created on : 9 Dec, 2020, 12:44:16 PM
    Author     : Surendra
--%>
...
<html>
    ...
    <body>
        <div id="wrapper">
            <c:if test="${username ne 'dgpolicectc'}">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-6">
                                    <form:select path="recommendStatus" id="recommendStatus" class="form-control">
                                        ...
                                        <form:option value="RECOMMENDED" disabled="true">RECOMMENDED</form:option>
                                        <form:option value="NOT RECOMMENDED" disabled="true">NOT RECOMMENDED</form:option>
                                    </form:select>
                                </div>
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2">
                                    <label for="remarkRecommendation"> Remarks of C.S.B. </label>
                                </div>
                                <div class="col-lg-6">
                                    <form:textarea path="remarksOfCSB" id="remarksOfCSB" class="form-control" rows="4" cols="100" readonly="true"/>
                                </div>
