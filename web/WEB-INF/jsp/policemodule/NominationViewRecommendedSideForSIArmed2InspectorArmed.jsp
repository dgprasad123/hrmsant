<%-- 
    Document   : NominationViewRecommendedSideForSIArmed2InspectorArmed
    Created on : 12 Apr, 2023, 4:15:11 PM
    Author     : Manisha
--%>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" style="margin-bottom: 7px;" id="dateofPassTrainingDiv">
                                ...
                                <div class="col-lg-2">
                                    <form:input path="orderNoForPassedTrainingAsi" id="orderNoForPassedTrainingAsi" class="form-control" maxlength="6" readonly="true"/>  
                                </div>
                                <div class="col-lg-2">
                                    <label for="servingChargeOfCaseDate"> Date of Passing Training</label>
                                </div>
                                <div class="col-lg-2">
                                    <form:input path="dateOfPassedTrainingAsi" id="dateOfPassedTrainingAsi" class="form-control" readonly="true"/>  
                                </div>
                            </div> 
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="punishmentMinorPrior" id="punishmentMinorPrior" class="form-control" maxlength="3" onkeypress="return numbersOnly(event)" onkeyup="calculatePunishmentPrior()" readonly="true"/>
                                </div>
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="punishmentMinorDuring" id="punishmentMinorDuring" class="form-control" maxlength="3" onkeypress="return numbersOnly(event)" onkeyup="calculatePunishmentDuring()" readonly="true"/>
                                </div>
                                <div class="col-lg-2" style="text-align: center">
                                    <form:input path="punishmentMinorFrom" id="punishmentMinorFrom" class="form-control" maxlength="3" onkeypress="return numbersOnly(event)" onkeyup="calculatePunishmentFrom()" readonly="true"/>
                                </div>
                            ...
                            <div class="row" style="margin-bottom: 7px;" id="dateofServingDiv">
                                ...
                                <div class="col-lg-2">
                                    <form:input path="servingChargeOfCaseDate" id="servingChargeOfCaseDate" class="form-control" readonly="true"/>  
                                </div>
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-6">
                                    <form:textarea path="remarkRecommendation" id="remarkRecommendation" class="form-control" rows="4" cols="100"  maxlength="450" readonly="true"/>
                                </div>
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-6">
                                    <form:textarea path="remarksOfCSB" id="remarksOfCSB" class="form-control" rows="4" cols="100"  maxlength="450" readonly="true"/>
                                </div>
