<%-- 
    Document   : NominationViewForSIArmedr2InspectorPoliceArmed
    Created on : 12 Apr, 2023, 12:09:59 PM
    Author     : Manisha
--%>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2">
                                    <label for="adverseIfany"> CCR Status For the Preceeding 5 Years As on 31-03-2023</label>
                                </div>
                                <div class="col-lg-3">
