...
<style type="text/css">
    ...
    <body>
        <jsp:include page="Header.jsp">
            <jsp:param name="menuHighlight" value="PSANDCAPPLICATIONS" />
        </jsp:include>
                <h1 style="margin:0px;font-size:18pt;color:#777777;border-bottom:1px solid #DADADA;padding-bottom:5px;">NDC Application List (GA Quarter Pool)</h1>
                    ...
                    <div class="panel-body">
                            ...
                            <thead>
                                <tr bgcolor="#EAEAEA">
                                    ...
                                    <th width="10%">Pension Sanctioning Authority</th>
                            ...
                            <tbody>
                                <c:forEach items="${applicationList}" var="aList">
                                    <tr>
                                        ...
                                        <td>${aList.pensionSanctioningAuthority}</td>
                                        <td>${aList.hrmsId}</td>
                                        <td>${aList.gpfNo}</td>
                                        <td>${aList.mobile}</td>
