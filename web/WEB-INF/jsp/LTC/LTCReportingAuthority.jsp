...
<html>
    <head>
        ...
        <title>LTC:: Reporting Authority</title>
    ...
    <body>
       <jsp:include page="ProfileTabs.jsp">
            <jsp:param name="menuHighlight" value="LTCRA" />
            <jsp:param name="ltcID" value="${ltcId}" />
        </jsp:include>
        <div style="width:95%;margin:0px auto;border-top:0px;font-family:Arial;font-size:14pt;">
            
<form action="SaveReportingAuthority.htm" commandName="LTCBean" method="post">
            <input type="hidden" name="ltcId" value="${ltcId}" />
            <div id="p" class="easyui-panel" title="LTC:: Reporting Authority" style="font-family:Arial;width:100%;height:100%;padding:10px;">
<h3>${authorityName}</h3>
                ...
                <div style="padding-left: 28px;margin-bottom:20px">
                    ...
                    <input class="easyui-combobox" id="auth" name="rAuthoritySpc" style="width:50%;height:26px;" data-options="valueField:'value',textField:'label',editable:false"/>
                </div>
            </div>
