...
<html>
    ...
    <body>
        <div>
            <form:form action="savesLTCEntry.htm" method="post" commandName="sLTCBean">
                ...
                <div class="container-fluid">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            <input type="submit" name="action" value="Save LTC" class="btn btn-default" onclick="return saveCheck();"/>
