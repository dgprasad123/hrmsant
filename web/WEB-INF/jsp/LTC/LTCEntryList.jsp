...
<html>
    ...
    <body>
        <form:form action="newLTCEntry.htm" method="post" commandName="sLTCBean">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <c:forEach items="${ltcList}" var="lList">
                                    <tr>
                                        ...
                                        <td>${lList.fblYear}</td>
                                        <td>${lList.tblYear}</td>                                        
                                        <td><a href="editLTCEntry.htm?notId=${lList.hidNotId}">Edit</a></td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                        </table>
                    ...
                    <div class="panel-footer">
                        ...
                        <button type="submit" class="btn btn-default">New LTC</button>  
                    </div>
                </div>
            </div>
        </form:form>
