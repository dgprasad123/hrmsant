...
<html>
    ...
    <body>
        <form:form action="saveRepatriation.htm" method="POST" commandName="repatriationForm">
            <div class="container-fluid">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form:hidden path="repatriationId" id="repatriationId"/>
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            ...
                            <div class="col-lg-1">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#repatriationAuthorityModal">
                    ...
                    <div class="panel-footer">
                        <input type="submit" name="btnRepatriation" value="Save Repatriation" class="btn btn-default" onclick="return saveCheck();"/>
                        <c:if test="${not empty promotionForm.promotionId}">
                            <input type="button" name="btnRepatriation" value="Delete" class="btn btn-default" onclick="return confirm('Are you sure to delete?');"/>
                        </c:if>
                    </div>
                </div>
            </div>

            <div id="repatriationAuthorityModal" class="modal" role="dialog">
