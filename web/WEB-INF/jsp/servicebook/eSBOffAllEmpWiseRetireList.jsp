            ...
            <div class="container-fluid">
                <div class="panel panel-default">
                                    ...
                                    <p><a href="eSBDeptWiseRetireList.htm?year=${year}">Department Wise Report</a> &raquo;
                                        <a href="eSBOfficeWiseRetireList.htm?year=${year}&deptCode=${deptCode}">${deptName}</a></p>
                                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <c:forEach items="${officeList}" var="dList" varStatus="slnoCnt">
                                    <tr<c:if test="${dList.isSbCompleted == 'Yes'}"> bgcolor="#C1FFA0"</c:if>>
                                        ...
                                        <td>${dList.dos}</td>
                                        <td><a href="EmployeeServiceBookByID.htm?empid=${dList.hrmsId}" target="_blank">View Service Book</a></td>
                                    </tr>                                
                                </c:forEach>
                            </tbody>
                        </table>
