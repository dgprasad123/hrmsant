            ...
            <div class="container-fluid">
                <div class="panel panel-default">
                    ...
                    <div class="row" style="margin:10px 0px;margin-left:20px;font-size:14pt;">
                        <p><span  style="color:#666666;text-decoration:underline;">District Wise Report</span></p>
                    </div>
                    <div style="position:fixed;top:100px;right:30px;text-align:right;">
                        <%--<input type="button" value="DownloadExcel" 
                               class="btn btn-md btn-primary"/>--%>
                        <button type="button" class="btn btn-md btn-success"><a href="downloadeSBDistrcitWiseRetireList.htm?deptcode=${deptCode}"><b style="color:black">Download Excel</b></a></button>
                    ...
                    <div class="panel-heading" style="font-weight:bold;font-size:15pt;">
                        Service Book Monitoring District Wise Report
                    </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>                                    
                                    ...
                                    <th style="text-align:center" >District Name<br>(2)</th>
                            ...
                            <tbody>
                                <c:forEach items="${deptList}" var="dList" varStatus="slnoCnt">
                                    <tr>
                                        ...
                                        <td><a href="eSBDistOfficeWiseRetireList.htm?distCode=${dList.districtId}&year=${year}">${dList.districtName}</a></td>
