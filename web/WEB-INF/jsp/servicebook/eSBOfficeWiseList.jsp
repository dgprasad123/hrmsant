            ...
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="row" style="margin:10px 0px;">
                        ...
                        <div class="col-lg-2"><input type="button" value="Search" class="btn btn-primary" onclick="self.location='eSBOfficeWiseList.htm?fromDate='+$('#fromDate').val()+'&toDate='+$('#toDate').val()+'&deptCode='+$('#deptCode').val()" /></div>
                    </div>
                            ...
                            <tbody>
                                <c:forEach items="${officeList}" var="dList" varStatus="slnoCnt">
                                    <tr>
                                        ...
                                        <td><a href="eSBEmpWiseList.htm?deptCode=${deptCode}&offCode=${dList.offCode}&fromDate=${fromDate}&toDate=${toDate}">${dList.officeName}</a></td>
