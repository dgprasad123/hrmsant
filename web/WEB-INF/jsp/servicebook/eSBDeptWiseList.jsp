            ...
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="row" style="margin:10px 0px;">
                        ...
                        <div class="col-lg-2"><input type="button" value="Search" class="btn btn-primary" onclick="self.location='eSBDeptWiseList.htm?fromDate='+$('#fromDate').val()+'&toDate='+$('#toDate').val()" /></div>
                    </div>
                            ...
                            <tbody>
                                <c:forEach items="${deptList}" var="dList" varStatus="slnoCnt">
                                    <tr>
                                        ...
                                        <td><a href="eSBOfficeWiseList.htm?deptCode=${dList.departmentId}&fromDate=${fromDate}&toDate=${toDate}">${dList.departmentName}</a></td>
