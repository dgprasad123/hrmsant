<%-- 
    Document   : npsdataexcel
    Created on : Apr 19, 2022, 11:57:00 AM
    Author     : Madhusmita
--%>
                    ...
                    <div class="row">
                        <div class="col-lg-12">                            
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-file"></i> HRMS NPS DATA 
                                </li>                                
                            </ol>
                        </div>
                    </div>
                    <div style="text-align:center;">
                        <form:form action="npsdataexcel.htm" commandName="npsDataForm" method="POST">
                                    ...
                                    <div class="col-lg-12">                                        
                                        <div class="col-50">
                                            <div class="pull-center" style="height:20px;">                                                        
                                                <h3><u><b>HRMS NPS DATA</b></u></h3>
                                            </div>
                                        </div>  
                                        <br/><br/>
                                        <div class="col-lg-12" style="margin-bottom: 7px;">
                                            <div class="col-lg-4">
                                                <form:select path="billtype" id="billtype" class="form-control">
