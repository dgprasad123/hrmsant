        ...
        <div align="center">
            <div style="width:1000px;margin-top: 20px">
                <table width="100%" border="0" style="font-family:verdana;">
                    ...
                    <tr>
                        <td > HRMS BILL No: <span style="font-weight: bold;"> ${billChartOfAccount.billid} </span>  </td>
                        <td > Token No:&nbsp;&nbsp; <span style="font-weight: bold;"> ${billChartOfAccount.tokenNo}</span>  </td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family:verdana;" id="tableset">
                    <tr>
                        <td width="60%" class="borderTopRightandBottom" style="font-size:12px;padding-left:5px;" valign="top"> 
                            Space for classification stamp of manuscript entries of classification to be filled in by Drawing Officer,
                            ...
                            <div>
                                <p style="text-align: justify;font-size: 12px;">1.Hold over amounts should be entered in red ink in the appropriate col. 3,4,5 and 6 as the case may 
                            ...
                            <div>
                                <p style="text-align: justify;font-size: 12px;">2. In the Remarks column 15 should be recorded all unusual permanent events such as death, retirements, 
                                    transfers and first appointments which find no place increment certificates or absentee statement.</p>
                            </div>
                            <div>
                                <p style="text-align: justify;font-size: 12px;">3. When the increment claimed operates to carry a Government Servant Govt. to efficiency bar it should be 
                                    supported by a declaration that the Government servants in question is fit to pass the bar (S.T.R. 6).</p>
                            </div>
                            <div>
                                <p style="text-align: justify;font-size: 12px;">4. Names of Government servants in inferior services as well as those mentioned [S.T.R.55(3)]
                                    may be omitted from pay bill (S.T.R.55).</p>
                            </div>
                            <div>
                                <p style="text-align: justify;font-size: 12px;">5. A red line should be drawn right across the sheet after each section of the punishment and
                                    under it is totals of columns 4,5,6 and 7 and 8 of the section should be shown in red ink.</p>
                            </div>
                            <div>
                                <p style="text-align: justify;font-size: 12px;">6. In cases where the amount of leave salary is based on average pay separate statement showing the 
                                    calculation of average pay duly attested by Drawing Officer should be attachment to this bill vide [S.T.R.55 (3)].</p>
                            </div>
                            <div>
                                <p style="text-align: justify;font-size: 12px;">7. The names of men holding post substantively should be entered in order of Seniority as measured by substantive  
                                    pay drawn and below those will be shown the parts left vacant and the men officiating in the vacancies.</p>
                            </div>
                            <div>
                                <p style="text-align: justify;font-size: 12px;">8. Officiating pay should be record in the section of the bill appropriate to that in which the
                            ...
                            <div>
                                <p style="text-align: justify;font-size: 12px;">9. The following abbreviations should be use in this and in all other document, submitted with pay bill.</p>
                            </div>
