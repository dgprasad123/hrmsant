        ...
        <script type="text/javascript">
            ...
            function openRevert() {
                ...
                if (row) {
                    ...
                    var rows = $('#emplistthirdscheduledg').datagrid('getSelections');
                    var isVerifyingAuthSubmitted = "N";
                    var isCheckingAuthApproved = "N";
                    for (var i = 0; i < rows.length; i++) {
                        if (rows[i].isApproved == 'Y') {
                            isCheckingAuthApproved = "Y";
                        }
                    }
                    if (isCheckingAuthApproved == "N") {
                        for (var i = 0; i < rows.length; i++) {
                            if (rows[i].isVerifyingAuthSubmitted == 'Y') {
                                isVerifyingAuthSubmitted = "Y";
                            } else {
                    ...
                    $('#chkEmp').val(ids);
                    if (isCheckingAuthApproved == "Y") {
                        alert("One of the selected Employee is already Approved by Checking Authority!");
                    } else if (isVerifyingAuthSubmitted == "Y") {
