        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form:form class="form-inline" action="DownloadLoanPDFAGTest.htm" method="POST" commandName="billBrowserForm" >
                            <div class="form-group">
                                <label for="sltTrCode">Choose Treasury:</label>
                                <form:select path="sltTrCode" class="form-control">
                                    <form:option value="">--Select--</form:option>
                                    <form:options items="${trlist}" itemLabel="treasuryName" itemValue="treasuryCode"/>
                                </form:select>    
                            </div>
                            <div class="form-group">
