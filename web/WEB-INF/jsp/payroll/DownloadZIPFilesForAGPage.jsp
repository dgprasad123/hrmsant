        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form:form class="form-inline" action="DownloadZIPFilesForAG.htm" method="POST" commandName="billBrowserForm" >
                            <div class="form-group">
                                <label for="sltLoan">Choose Download Type:</label>
                                <form:select path="sltLoan" class="form-control">
                                    <form:option value="">--Select--</form:option>
                                    <form:option value="A">Aquitance</form:option>
                                    <form:option value="S">Schedule</form:option>
                                    <form:option value="L">LTA</form:option>
                                </form:select>    
                            </div>
                            <div class="form-group">
