                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-file"></i> Download PDF File
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <c:if test="${not empty filepath}">
                            File Path is - <c:out value="${filepath}"/><br />
                            File Name is - <c:out value="${fileName}"/><br />
                            Directory Path is - <c:out value="${dirpath}"/><br />
                            Physical File Name is - <c:out value="${physicalFileName}"/><br />
                            Physical File Length is - <c:out value="${physicalFileLength}"/>
                        </c:if>
                        <form:form class="form-inline" action="DownloadLoanPDFAG.htm" method="POST" commandName="billBrowserForm" >
                            ...
                            <div class="form-group">
                                ...
                                <form:select path="sltLoan" class="form-control">
                                    ...
                                    <form:option value="AISGIS">AISGIS</form:option>
