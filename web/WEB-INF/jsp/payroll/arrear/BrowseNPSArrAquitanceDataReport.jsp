...
<html>
    ...
    <body style="margin:10px;">
        ...
        <table style="font-size:10pt;" width="100%" class="table table-bordered">
            <tr>
                <td colspan="16" style="text-align:center;background:#EAEAEA;" bgcolor="#EAEAEA">
                    <c:if test="${not empty HeaderDataList}">
                        <c:forEach var="hdrData" items="${HeaderDataList}">
                            <b> BILL  FROM <c:out value="${hdrData.fromMonth}"/> / <c:out value="${hdrData.fromYear}"/> TO 
            ...
            <tr>
                ...
                <td colspan="8" style="font-size:11pt;"><strong>Designation : </strong>${arrAqMastBean.curDesg}</td>
            </tr>
            <tr>
                <th rowspan="2"  width="3%">Sl No </th>
                <th rowspan="2" width="9%" style="text-align:center;">Month</th>
                <th colspan="6" width="18%" style="text-align:center;">Due</th>
                <th colspan="6" width="18%" style="text-align:center;">Drawn</th>
                <th rowspan="2" width="7%">Drawn Vide <br/> Bill No.</th>
                <th rowspan="2" width="5%" style="text-align:right;">Arrear 100%</th>                
            </tr>
            <tr>
                <th>Pay</th>
                <th>G.P</th>
            ...
            <tr>
                <th colspan="15" style="text-align: right;"> Grand Total &nbsp;&nbsp;&nbsp;&nbsp;</th>
                <th width="8%" style="text-align: right;"><c:out value="${arrAqMastBean.grandTotArr100}"/></th>                
            </tr>            
            <tr>
                <th colspan="15" style="text-align: right;"> Income Tax &nbsp;&nbsp;&nbsp;&nbsp;</th>                
                <th width="8%" style="text-align: right;">${arrAqMastBean.incomeTaxAmt}</th>                 
            </tr>
             <tr>
                <th colspan="15" style="text-align: right;"> 50% of Full Arrear Pay &nbsp;&nbsp;&nbsp;&nbsp;</th>                
                <th width="8%" style="text-align: right;">${arrAqMastBean.arrearpay}</th>               
            </tr>
            <tr>
                <th colspan="15" style="text-align: right;"> <c:out value="${accType}"/> &nbsp;&nbsp;&nbsp;&nbsp;</th>                
                <th width="8%" style="text-align: right;">${arrAqMastBean.cpfHead}</th>                 
            </tr>                          
            <tr>
                <th colspan="15" style="text-align: right;"> PT &nbsp;&nbsp;&nbsp;&nbsp;</th>                
                <th width="8%" style="text-align: right;">${arrAqMastBean.pt}</th>                 
            </tr>           
            <tr>
                <th colspan="15" style="text-align: right;background-color: #F5F5F5;"> Net Payable &nbsp;&nbsp;&nbsp;&nbsp;</th>                
                <th width="8%" style="text-align: right;background-color: #F5F5F5;">${(arrAqMastBean.grandTotArr100) - (arrAqMastBean.incomeTaxAmt) - (arrAqMastBean.pt)-(arrAqMastBean.cpfHead)}</th>                
            </tr>
        </tbody>
    </table>
