        ...
        <script type="text/javascript">
            ...
            function addEmployeeToBill() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        console.log(data);
                        alert("aqslNo is: "+data.aqslNo);
                        if (data.msgcode == 1) {
                            $("#addempmsg").text(data.message);
                        } else {
                            if(data.aqslNo == ""){
                                alert("Employee has already been added in another bill.");
                            }else{
                ...
                if (confirm('Are You sure to Reprocess ? ')) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            }else if (data.processed == 2) {
                                alert("Employee already present in another bill");
                            }
                        },
                        error: function () {
                            alert('Error Occured');
                        ...
                        <thead>
                            <tr>
                                ...
                                <c:if test="${(BillSts < 2) or (BillSts == 4) or (BillSts == 8)}"> 
                                    ...
                                    <th width="10%">Other<br />Recovery</th>
                                </c:if>
                        ...
                        <tbody>
                            <c:forEach items="${AqArrList}" var="arrAqMast" varStatus="cnt">    
                                <tr>
                                    ...
                                    <td>
                                        ${arrAqMast.arrear40 - (arrAqMast.incomeTaxAmt + arrAqMast.cpfHead + arrAqMast.pt)}
                                    </td>
                                    <td>
