    ...
    <body>
            ...
            <table border="1" cellpadding="0" id="reportgrid" cellspacing="0" width="100%" style="align:center">
                ...
                <c:if test="${billtype ne 'ARREAR'}">
                    <c:if test="${not empty allowanceList}">
                        <c:forEach var="eachEmpA" items="${allowanceList}">
                            <c:if test="${eachEmpA.adname != 'GP'}">
                                <c:if test="${eachEmpA.adname == 'PAY'}">
                                    <tr>
                                        <td align="center" style="border: 1px solid black;">
        ...
        <div align="center" style="width:95%;padding-top:15px;margin: 0 auto;" class="printData">
            ...
            <table border="1" cellpadding="0" id="reportgrid" cellspacing="0" width="100%" style="align:center">
                ...
                <c:if test="${not empty deductionObj}">
                    <tr>
                        <td align="center" style="border: 1px solid black;">
                            <c:out value="${deductionObj.itObjHead}"/>&nbsp;
                        </td>
                        <td align="center" style="border: 1px solid black;"> 
                            IT&nbsp;
                        </td>
                        <td align="center"  style="border: 1px solid black;">
                            <c:out value="${deductionObj.itAmt}"/>&nbsp;
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="border: 1px solid black;">
                            <c:out value="${deductionObj.cpfObjHead}"/>&nbsp;
                        </td>
                        <td align="center" style="border: 1px solid black;"> 
                            ${deductionObj.acctType}&nbsp;
                        </td>
                        <td align="center"  style="border: 1px solid black;">
                            <c:out value="${deductionObj.cpfAmt}"/>&nbsp;
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="border: 1px solid black;">
                            <c:out value="${deductionObj.ptObjHead}"/>&nbsp;
                        </td>
                        <td align="center" style="border: 1px solid black;"> 
                            PT&nbsp;
                        </td>
                        <td align="center"  style="border: 1px solid black;">
                            <c:out value="${deductionObj.ptAmt}"/>&nbsp;
                        </td>
                    </tr>
                    <c:if test="${deductionObj.orAmt > 0}">
                        <tr>
                            <td align="center" style="border: 1px solid black;">
                                <c:out value="${deductionObj.orObjHead}"/>&nbsp;
                            </td>
                            <td align="center" style="border: 1px solid black;"> 
                                OR&nbsp;
                            </td>
                            <td align="center"  style="border: 1px solid black;">
                                <c:out value="${deductionObj.orAmt}"/>&nbsp;
                            </td>
                        </tr>
                    </c:if>
                    <%--<c:if test="${deductionObj.drAmt > 0}">
                        <tr>
                            <td align="center" style="border: 1px solid black;">
                                <c:out value="${deductionObj.drObjHead}"/>&nbsp;
                            </td>
                            <td align="center" style="border: 1px solid black;"> 
                                DR&nbsp;
                            </td>
                            <td align="center"  style="border: 1px solid black;">
                                <c:out value="${deductionObj.drAmt}"/>&nbsp;
                            </td>
                        </tr>
                    </c:if>--%>
                </c:if>
        ...
        <div align="center" style="width:95%;padding-top:15px;padding-bottom:25px;margin: 0 auto;" class="printData">
            <table border="1" cellpadding="0" id="reportgrid" cellspacing="0" width="100%" style="align:center">
                ...
                <tr>
                    ...
                    <td align="center" style="border: 1px solid black;"> 
                        &nbsp;<c:out value="${netTotal}"/>
                    </td>
                    <td align="center"  style="border: 1px solid black;">
                        &nbsp;<c:out value="${deductAmt}"/>
                    </td>
                </tr>
            </table>
        </div>            
