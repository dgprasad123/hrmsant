...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function reprocessArrAqMast(empCode, billNo) {
                if (confirm('Are You sure to Reprocess ? ')) {
                    $.ajax({
                        type: "GET",
                        url: "reprocessArrAqMast.htm",
                        data: {empCode: empCode, billNo: billNo},
                        success: function (data) {
                            console.log(data);
                            if (data.processed == 1) {
                        ...
                        <tbody>
                            <c:forEach items="${AqArrList}" var="arrAqMast" varStatus="cnt">    
                                <tr>
                                    ...
                                    <td>${arrAqMast.arrearpay}</td>
                                    <td>
                                        <a href="browseArrAqData.htm?empCode=${arrAqMast.empCode}&billNo=${billNo}" class="btn btn-default"><img src="images/view_icon.png" alt="View Detail"/></a> <br/>
                                    </td>
                                    <c:if test="${(BillSts < 2) or (BillSts == 4) or (BillSts == 8)}"> 
                                        <td>
                                            <a href="deleteArrMast.htm?empCode=${arrAqMast.empCode}&billNo=${billNo}" class="btn btn-default"><img src="images/delete_icon.png" alt="Delete"/></a>
                                        </td>
                                    </c:if>
                                    <c:if test="${(BillSts < 2) or (BillSts == 4) or (BillSts == 8)}"> 
                                        <td>
                                            <a href="javascript:reprocessArrAqMast('${arrAqMast.empCode}','${billNo}')" class="btn btn-default"><img src="images/process.png" height="20" alt="Reproess"/></a>
                                        </td>                                        
                                    </c:if>
                                </tr>
                            </c:forEach>
