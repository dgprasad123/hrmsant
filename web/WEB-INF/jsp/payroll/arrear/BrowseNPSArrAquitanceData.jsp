        ...
        <script type="text/javascript">
            ...
            function editArrData(aqslno, pMonth, pyear, billNo, calcuniqueno) {
                $.ajax({
                    type: "GET",
                    url: "editArrData.htm",
                    data: {aqslno: aqslno, pmonth: pMonth, pyear: pyear, billNo: billNo, calcuniqueno: calcuniqueno},
                    success: function(data) {
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <c:if test="${not empty arrAqMastBean.arrDetails}">
                                <c:forEach var="arrAqDtls" items="${arrAqMastBean.arrDetails}" varStatus="cnt">
                                    <tr style="height: 25px" id="${arrAqDtls.aqslno}_${arrAqDtls.payMonth}_${arrAqDtls.payYear}_${arrAqDtls.calcuniqueno}">
                                        ...
                                        <td>
                                            <c:out value="${arrAqDtls.dueDaAmt}"/>
                                        </td>
                            ...
                            <tr>
                                <th colspan="11" style="text-align: right;background-color: #F5F5F5;"> Full Arrear Pay &nbsp;&nbsp;&nbsp;&nbsp;</th>
                                <th width="8%" style="text-align: center;background-color: #F5F5F5;"><c:out value="${arrAqMastBean.fullArrearpay}"/></th>
                                <th width="8%" style="text-align: center;background-color: #F5F5F5;">&nbsp;</th>
                                <th width="8%" style="text-align: center;background-color: #F5F5F5;">&nbsp;</th>
                            </tr>                        
                            <tr>
                                <th colspan="11" style="text-align: right;background-color: #F5F5F5;"> 50% of Full Arrear Pay &nbsp;&nbsp;&nbsp;&nbsp;</th>
                                <th width="8%" style="text-align: center;background-color: #F5F5F5;"><c:out value="${arrAqMastBean.arrearpay}"/></th>
                                <th width="8%" style="text-align: center;background-color: #F5F5F5;">&nbsp;</th>
                                <th width="8%" style="text-align: center;background-color: #F5F5F5;">&nbsp;</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <th width="8%" style="text-align: center;background-color: #F5F5F5;">0</th>
                                <th width="8%" style="text-align: right;background-color: #F5F5F5;">&nbsp;</th>
                            </tr>
                        </tbody>
                    </table>
