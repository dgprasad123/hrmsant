        ...
        <div height="700" id="divId">
            <table width="100%" border="0">
                <tr>
                    ...
                    <td width="15%" align="center">BILL NO:<c:out value="${billdesc}" /><br> BILL DT:<c:out value="${billdate}" /></td>
            ...
            <c:forEach begin="0" end="${fn:length(ArrEmpList)/pagesize}">
                <table width="100%" style="border-top: 0;border-bottom: 0">
                    <tr>
                        ...
                        <td width="15%">NAME AND DESGIGNATION </td>
                        <td width="5%" align="center">PAY <br/> GP<br />IR</td>
                        <td width="5%" align="center">DA</td>
                        <td width="5%" align="center">HRA</td>
                        <td width="5%" align="center">OA</td>
                        <td width="5%" align="center">GROSS Arrear</td>
                        <td width="5%" align="center">GPF/CPF/TPF</td>
                        <td width="5%" align="center">P.TAX</td>
                        <td width="5%" align="center">I.TAX</td>                    
                        <td width="5%" align="center">OTHER<br />RECOVERY</td>
                        <td width="5%" align="center">DDO<br />RECOVERY</td>
                ...
                <table width="100%" border="0" id="tableData">
                    <c:forEach var="eachArrEmp" items="${ArrEmpList}" begin="${count}" end="${count+pagesize}">
                        ...
                        <c:set var="totalor" value="${totalor + eachArrEmp.otherRecovery}"/>
                        <c:set var="totaldr" value="${totaldr + eachArrEmp.ddoRecovery}"/>
                        <c:set var="totdeduction" value="${totdeduction + (eachArrEmp.cpfHead+eachArrEmp.professionalTax+eachArrEmp.incomeTaxAmt+eachArrEmp.otherRecovery+eachArrEmp.ddoRecovery)}"/>
                        <c:set var="totalnet" value="${totalnet + (eachArrEmp.grandTotArr100-(eachArrEmp.cpfHead+eachArrEmp.professionalTax+eachArrEmp.incomeTaxAmt+eachArrEmp.otherRecovery+eachArrEmp.ddoRecovery))}"/>
                        <tr style="height: 60px;">
                            ...
                            <td width="5%" valign="top" align="center">${eachArrEmp.payTotal}<br/>${eachArrEmp.gpTotal}<br />${eachArrEmp.irTotal}</td>
                            <td width="5%" valign="top" align="center">${eachArrEmp.daTotal}</td>
                            <td width="5%" valign="top" align="center">${eachArrEmp.hraTotal}</td>
                            <td width="5%" valign="top" align="center">${eachArrEmp.oaTotal}</td>
                            ...
                            <td width="5%" valign="top" align="center">${eachArrEmp.otherRecovery}</td>
                            <td width="5%" valign="top" align="center">${eachArrEmp.ddoRecovery}</td>
                            <td width="5%" valign="top" align="center">${eachArrEmp.cpfHead+eachArrEmp.professionalTax+eachArrEmp.incomeTaxAmt+eachArrEmp.otherRecovery+eachArrEmp.ddoRecovery}</td>
                            <td width="5%" valign="top" align="center">${eachArrEmp.grandTotArr100-(eachArrEmp.cpfHead+eachArrEmp.professionalTax+eachArrEmp.incomeTaxAmt+eachArrEmp.otherRecovery+eachArrEmp.ddoRecovery)}</td>
            ...
            <table width="100%" border="1">
                <tr>
                    ...
                    <td width="5%" valign="top" align="center">${totalor}</td>
                    <td width="5%" valign="top" align="center">${totaldr}</td>
                    <td width="5%" valign="top" align="center">${totdeduction}</td>
                ...
                <tr>
                    <td colspan="11"><b><div align="right">Rupees &nbsp;
                                <%
                                    if (!(((Long) pageContext.getAttribute("totalnet")).equals("0"))) {
                                        Long netamountinword = (Long) pageContext.getAttribute("totalnet");
