...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function deleteArrear40Data(billno, vchno) {
                ...
                if (empid != "" && vchno == "") {
                    if (confirm('Are you sure to Delete this Bill?')) {
                        window.location = "DeleteArrear40Data.htm?billNo=" + billno + "&empid=" + empid;
                    } else {
                        return false;
                    }
                }
            }
            function deleteArrear40DuplicateData(aqslno, billno) {
                var empid = $('#empCode').val();
                if (empid != "") {
    ...
    <body>
        <div class="container-fluid">
            <form:form action="Arrear40VerificationDetailData.htm" method="POST" commandName="command">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <input type="submit" name="btnArrear40" value="Get Data" class="btn btn-danger"/>
                            </div>
                        </div>
                            ...
                            <tbody>
                                <c:forEach items="${billList}" var="list" varStatus="count">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="browseArrAqDataReport.htm?aqslno=${list.aqSlNo}&billNo=${list.billNo}" target="_blank">View</a>
                                        </td>
                                        <td>
                                            <c:if test="${list.billstatusid < 2}">
                                                <a href="javascript:void(0);" onclick="deleteArrear40Data('${list.billNo}', '${list.vchno}');">Delete Employee From Bill</a>
                                            </c:if>
                                        </td>
                                        <td>   
                                            <c:if test="${list.billstatusid >= 2}">
