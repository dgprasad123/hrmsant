            ...
            <table width="100%" border="0">
                ...
                <tr>
                    <td style="text-align:center;font-size:15px;">
                        For the month of &nbsp;<c:out value="${monthNam1}"/>-<c:out value="${year1}"/> to <c:out value="${monthName2}"/>-<c:out value="${year2}"/>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div id="priDataDiv" style="width:90%;margin: 0 auto;font-size:13px; font-family:verdana;">
            ...
            <table border="0" width="100%"  cellspacing="0" cellpadding="0" style="font-size:14px; font-family:verdana;">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td height="10px">&nbsp;
                        <p style="padding-left:5px;text-align: justify;"> <b>A.</b> Please Pay <b><c:out value="${netPay}"/> &nbsp; (<c:out value="${netPayWord}"/>)</b> by transfer credit to the saving bank 
        ...
        <div style="width:90%;margin: 0 auto;font-size:13px; font-family:verdana;">                    
            ...
            <table border="1" width="100%"  cellspacing="0" cellpadding="0" style="font-size:14px; font-family:verdana;margin-top: 20px;">
                ...
                <tr style="height:40px;">
                    ...
                    <td align="center"> <c:out value="${payhead}"/> </td>
                    <td align="center"> <c:out value="${dahead}"/> </td>
                    <td align="center"> <c:out value="${hrahead}"/> </td>
                    <td align="center"> <c:out value="${oahead}"/> </td>
                </tr>
                <tr style="height:40px;">
                    <th> BALANCE </th>
                    <td>&nbsp; </td>
