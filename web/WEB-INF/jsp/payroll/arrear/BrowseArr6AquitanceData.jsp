...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function editArrData(aqslno, pMonth, pyear, billNo, calcuniqueno,autoincrid) {
                
                $.ajax({
                    type: "GET",
                    url: "editArrData.htm",
                    data: {aqslno: aqslno, pmonth: pMonth, pyear: pyear, billNo: billNo, calcuniqueno: calcuniqueno, autoincrid: autoincrid},
                    success: function (data) {

                        $("#hidAqSlno").val(data.aqslno);
                        $("#hidCalcuniqueno").val(data.calcuniqueno);
                        $("#hidautoincrid").val(data.autoincrid);
            ...
            function UpdateArrDtlsData() {
                ...
                var autoincrid = $("#hidautoincrid").val();
                ...
                if (drawnPay == '') {
                    ...
                    $.ajax({
                        type: "GET",
                        dataType: "json",
                        url: "updateArr6Dtls.htm",
                        data: {aqslno: aqSlno, calcuniqueno: calcuniqueno, autoincrid: autoincrid,payMonth: pMonth, payYear: pYear, duePayAmt: duePay, drawnBillNo: drawnBill,
                            dueGpAmt: dueGp, dueDaAmt: dueDa, drawnPayAmt: drawnPay, drawnGpAmt: drawnGp, drawnDaAmt: drawnDa},
                        success: function (data) {                            
                            $("#" + aqSlno + "_" + pMonth + "_" + pYear + "_" + calcuniqueno + "_" + autoincrid).children().eq(2).html(data.duePayAmt);
                            $("#" + aqSlno + "_" + pMonth + "_" + pYear + "_" + calcuniqueno + "_" + autoincrid).children().eq(3).html(data.dueGpAmt);
                            $("#" + aqSlno + "_" + pMonth + "_" + pYear + "_" + calcuniqueno + "_" + autoincrid).children().eq(4).html(data.dueDaAmt);
                            var totDueAmt = data.duePayAmt + data.dueGpAmt + data.dueDaAmt;
                            $("#" + aqSlno + "_" + pMonth + "_" + pYear + "_" + calcuniqueno + "_" + autoincrid).children().eq(5).html(totDueAmt);

                            $("#" + aqSlno + "_" + pMonth + "_" + pYear + "_" + calcuniqueno + "_" + autoincrid).children().eq(6).html(data.drawnPayAmt);
                            $("#" + aqSlno + "_" + pMonth + "_" + pYear + "_" + calcuniqueno + "_" + autoincrid).children().eq(7).html(data.drawnGpAmt);
                            $("#" + aqSlno + "_" + pMonth + "_" + pYear + "_" + calcuniqueno + "_" + autoincrid).children().eq(8).html(data.drawnDaAmt);
                            var totDrawnAmt = data.drawnPayAmt + data.drawnGpAmt + data.drawnDaAmt;
                            $("#" + aqSlno + "_" + pMonth + "_" + pYear + "_" + calcuniqueno + "_" + autoincrid).children().eq(9).html(totDrawnAmt);

                            $("#" + aqSlno + "_" + pMonth + "_" + pYear + "_" + calcuniqueno + "_" + autoincrid).children().eq(10).html(data.drawnBillNo);

                            var totArr100 = totDueAmt - totDrawnAmt;
                            $("#" + aqSlno + "_" + pMonth + "_" + pYear + "_" + calcuniqueno + "_" + autoincrid).children().eq(11).html(totArr100);
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-hover">
                        <tr>
                            ...
                            <th colspan="4" width="20%">Due</th>
                            <th colspan="4" width="20%">Drawn</th>
                            <th rowspan="2" width="15%">Drawn Vide <br/> Bill No.</th>
                        ...
                        <c:if test="${not empty arrAqMastBean.arrDetails}">
                            <c:forEach var="arrAqDtls" items="${arrAqMastBean.arrDetails}" varStatus="cnt">
                                <tr style="height: 25px" id="${arrAqDtls.aqslno}_${arrAqDtls.payMonth}_${arrAqDtls.payYear}_${arrAqDtls.calcuniqueno}_${arrAqDtls.autoincrid}">
                                    <td>${cnt.index+1}</td>
                                    ...
                                    <c:if test="${usertype eq 'A' or usertype eq 'D'}">
                                        <c:if test="${(BillSts < 2) or (BillSts == 4) or (BillSts == 8)}"> 
                                            <td align="center">
                                                <a href="javascript:editArrData('${arrAqDtls.aqslno}',${arrAqDtls.payMonth},${arrAqDtls.payYear},${arrAqMastBean.billNo},${arrAqDtls.calcuniqueno},${arrAqDtls.autoincrid})" class="btn btn-default"><img src="images/edit.png" alt="Edit"/></a>
                                            </td>
                                        </c:if>
                                    </c:if>
                                </tr> 
                        ...
                        <tr>
                            <th colspan="9" style="text-align: right;background-color: #F5F5F5;"> Grand Total &nbsp;&nbsp;&nbsp;&nbsp;</th>
                        ...
                        <tr>
                            <th colspan="9" style="text-align: right;background-color: #F5F5F5;">40% &nbsp;&nbsp;&nbsp;&nbsp;</th>
                            <th width="8%" style="text-align: center;background-color: #F5F5F5;"><c:out value="${arrAqMastBean.grandTotArr40}"/></th>
                            <th width="8%" style="text-align: center;background-color: #F5F5F5;">&nbsp;</th>
                            <th width="8%" style="text-align: center;background-color: #F5F5F5;">&nbsp;</th>
                        </tr>
                        <tr>
                            <th colspan="9" style="text-align: right;background-color: #F5F5F5;">${arrAqMastBean.percentageArraer}% &nbsp;&nbsp;&nbsp;&nbsp;</th>
                            <th width="8%" style="text-align: center;background-color: #F5F5F5;"><c:out value="${arrAqMastBean.grandTotArr60}"/></th>
                            <th width="8%" style="text-align: center;background-color: #F5F5F5;">&nbsp;</th>
                            <th width="8%" style="text-align: center;background-color: #F5F5F5;">&nbsp;</th>
                        </tr>
                        <tr>
                            <th colspan="9" style="text-align: right;background-color: #F5F5F5;"> Income Tax &nbsp;&nbsp;&nbsp;&nbsp;</th>
                        ...
                        <tr>
                            <th colspan="9" style="text-align: right;background-color: #F5F5F5;"> CPF &nbsp;&nbsp;&nbsp;&nbsp;</th>
                            <th width="8%" style="text-align: center;">&nbsp;</th>
                            <th width="8%" style="text-align: center;background-color: #F5F5F5;">${arrAqMastBean.cpfHead}</th> 
                            <th width="8%" style="text-align: center;">&nbsp;</th>
                        </tr>
                        <tr>
                            <th colspan="9" style="text-align: right;background-color: #F5F5F5;"> PT &nbsp;&nbsp;&nbsp;&nbsp;</th>
                            <th width="8%" style="text-align: center;">&nbsp;</th>
                            <th width="8%" style="text-align: center;background-color: #F5F5F5;">${arrAqMastBean.pt}</th> 
                            <th width="8%" style="text-align: center;">&nbsp;</th>
                        </tr>
                        <tr>
                            <th colspan="9" style="text-align: right;background-color: #F5F5F5;"> Net Payable &nbsp;&nbsp;&nbsp;&nbsp;</th>
                            <th width="8%" style="text-align: right;background-color: #F5F5F5;">&nbsp;</th>
                            <th width="8%" style="text-align: center;background-color: #F5F5F5;">${(arrAqMastBean.grandTotArr60) - (arrAqMastBean.incomeTaxAmt + arrAqMastBean.cpfHead + arrAqMastBean.pt)}</th>
                            <th width="8%" style="text-align: right;background-color: #F5F5F5;">&nbsp;</th>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div class="modal-content" >
                    ...
                    <div class="modal-body">
                        <table align="center" cellpadding="2" cellspacing="2">
                            ...
                            <tr style="height: 20px">     
                                <th><input type="hidden" name="aqslno" id="hidAqSlno"/><input type="hidden" name="calcuniqueno" id="hidCalcuniqueno"/><input type="hidden" name="autoincrid" id="hidautoincrid"/></th>
