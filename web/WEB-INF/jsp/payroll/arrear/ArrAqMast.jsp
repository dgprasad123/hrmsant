...
<html>
    ...
    <body>
        ...
        <div height="700" id="divId">
            ...
            <c:set var="totalotherrecovery" value="0"/>
            ...
            <c:forEach begin="0" end="${fn:length(ArrEmpList)/pagesize}">
                <table width="100%" style="border-top: 0;border-bottom: 0">
                    <tr>
                        ...
                        <td width="5%" align="center">
                            <c:if test="${commonreportbean.typeofBill == 'ARREAR'}">
                                Arrear 40 %
                            </c:if>
                            <c:if test="${commonreportbean.typeofBill == 'ARREAR_6'}">
                                <c:if test="${commonreportbean.percentageArraer eq 15}">
                                    Arrear 15/20%
                                </c:if>
                                <c:if test="${commonreportbean.percentageArraer ne 15}">
                                    Arrear ${commonreportbean.percentageArraer} %
                                </c:if>
                            </c:if>
                        </td>                                                
                ...
                <table width="100%" border="0" id="tableData">
                    <c:forEach var="eachArrEmp" items="${ArrEmpList}" begin="${count}" end="${count+pagesize}">
                        ...
                        <c:set var="totalotherrecovery" value="${totalotherrecovery + eachArrEmp.otherRecovery}"/>
                        <c:set var="totalnet" value="${totalnet + (eachArrEmp.grandTotArr40-(eachArrEmp.cpfHead+eachArrEmp.professionalTax+eachArrEmp.incomeTaxAmt+eachArrEmp.otherRecovery))}"/>
                        <tr style="height: 60px;">
                            ...
                            <td width="5%" valign="top" align="center">${eachArrEmp.cpfHead+eachArrEmp.professionalTax+eachArrEmp.incomeTaxAmt+eachArrEmp.otherRecovery}</td>
                            <td width="5%" valign="top" align="center">${eachArrEmp.grandTotArr40-(eachArrEmp.cpfHead+eachArrEmp.professionalTax+eachArrEmp.incomeTaxAmt+eachArrEmp.otherRecovery)}</td>
            ...
            <table width="100%" border="1">
                <tr>
                    ...
                    <td width="5%" valign="top" align="center">${totalotherrecovery}</td>
                ...
                <tr>
                    <td colspan="9"><b><div align="right">Rupees &nbsp;
                                <%
                                    if (!(((Double) pageContext.getAttribute("totalnet")).equals("0"))) {
