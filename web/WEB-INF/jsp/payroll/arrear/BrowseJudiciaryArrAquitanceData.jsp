        ...
        <script type="text/javascript">
            ...
            function SaveArrDtlsData() {
                ...
                if (payMonth == '') {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "saveJudiciaryArrData.htm",
                        data: {aqslno: aqSlno, payMonth: payMonth, payYear: payYear, duePayAmt: duePayAmt, drawnBillNo: drwnBillNo,
                            dueGpAmt: dueGpAmt, dueDaAmt: dueDaAmt, dueIrAmt: dueIRAmt, drawnPayAmt: drawnPayAmt,
                            drawnGpAmt: drawnGpAmt, drawnDaAmt: drawnDaAmt, drawnIrAmt: drawnIRAmt},
                        success: function(data) {
                            location.reload();
                        },
                        error: function() {
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            <th colspan="11" style="text-align: right;background-color: #F5F5F5;"><c:out value="${arrAqMastBean.percentageArraer}"/>% &nbsp;&nbsp;&nbsp;&nbsp;</th>
                ...
                <div class="modal-content" >
                    ...
                    <div class="modal-body">
                        <table align="center" cellpadding="2" cellspacing="2">
                            ...
                            <tr style="height: 40px">
                                <th>Due IR : &nbsp;</th>
                                <td><input type="text" name="addDueIRAmt" id="addDueIRAmt" maxlength="6" onkeypress="return onlyIntegerRange(event)"/></td>
                            </tr>
                            ...
                            <tr style="height: 40px">
                                <th>Drawn IR : &nbsp;</th>
                                <td><input type="text" name="addDrawnIRAmt" id="addDrawnIRAmt" maxlength="6" onkeypress="return onlyIntegerRange(event)"/></td>
                            </tr>
