        ...
        <form:form action="aqbillreport.htm" commandName="aqBillReport"  method="GET">
            <div height="800" id="divId">
                ...
                <table width="100%" style="border-top: 0;border-bottom: 0">
                    <tr>
                        ...
                        <td width='3%'>PVTDED<br/>BANK LOAN<br/>NET BALANCE </td>
            ...
            <table width="100%" border="1">
                <tr>
                    ...
                    <td width="5%"><c:out value="${aqBillReport.col19Tot}"/><br><c:out value="${aqBillReport.col191Tot}"/></td>
                    <td width="3%"><c:out value="${aqBillReport.col20Tot}"/><br><c:out value="${aqBillReport.col201Tot}"/><br><c:out value="${aqBillReport.col202Tot}"/></td>
                    <td width="7%">&nbsp;</td>          
                </tr>
