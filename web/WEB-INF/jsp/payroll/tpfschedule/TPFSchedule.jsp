...
<html>
    ...
    <body>
            ...
            <c:forEach var="eachGPFType" items="${TPFList}">
                <c:if test="${eachGPFType.empno > 0}">
                    <% 
                        ...
                        j = 0; 
                    %>
                <table width="98%" border="0" cellpadding="0" cellspacing="0" style="font-size:11px;">
                    <tr>
                    ...
                    <tr>
                        <td width="100%" style="text-align:center;" class="txtf">
                            ...
                            <span style="font-weight:bold;font-size: 14px;">(Voucher No/Voucher Date: <c:out value="${vchNo}"/>/<c:out value="${vchDate}"/>)</span>
                        </td> 
                    </tr>
                    <tr>
        ...
        <table width="98%" border="0"  cellpadding="0" cellspacing="0" style="font-size:12px;">
            <thead> </thead>
            <tr style="height:30px">
                <td colspan="8" >&nbsp;</td>
            </tr>
            ...
            <tr>
                <td width="100%" style="text-align:center;" class="txtf"><b>BILL NO: </b> <c:out value="${billDesc}"/></td>   
            </tr>
        ...
        <table width="98%" border="0" cellpadding="0" cellspacing="0" style="font-size:11px;">
            ...
            <c:if test="${not empty TPFAbstract}">
                <c:forEach var="GpfTypeBean" items="${TPFAbstract}">
                    <tr> 
                        <td width="50%" style="text-align:center;" class="txtf" height="45px"> <c:out value="${GpfTypeBean.pfcode}"/> </td>
                        <td width="50%" style="text-align:center;" class="txtf"> <c:out value="${GpfTypeBean.totalamt}"/></td>
                    </tr>
        ...
        <table id="tblbroughforward" width="98%" border="0" cellpadding="0" cellspacing="0" style="font-size:11px;">
            <thead></thead>
            <tr>
                <td colspan="8" style="text-align:right;" class="txtf">  &nbsp; </td>
            </tr>
        </table>
        <table width="98%" border="0" cellpadding="0" cellspacing="0" style="font-size:11px;">
            <tr>
            ...
            <tr>
                <td colspan="8" style="text-align:right;" class="txtf"> (RUPEES <%=amtwordsAbsract%> ) ONLY </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
        ...
        <table width="98%" border="0" cellpadding="0" cellspacing="0" style="font-size:11px;">
            <thead></thead>
            <tr width="100%">
                <td width="100%" colspan="2">Certified that all particulars of recovery have been correctly furnished as per the instruction issued 
                    in respect of preparation of G.P.F. Schedules.
                </td>
            </tr>
            <tr width="100%">
                <td width="70%" style="text-align:left;" class="txtf"> Voucher No.................................... </td>
                <td width="30%" style="text-align:left;" class="txtf"> Date of Encashment: / / </td>
            </tr>
            <tr>
                <td colspan="2"> &nbsp; </td>
            </tr>
            <tr width="100%" >
                <td colspan="2" style="text-align: center;" class="txtf"> FOR USE IN AUDIT OFFICE </td>
            </tr>
            <tr>
                <td colspan="2">Certified that the name and account No. of individual deduction and total shown in column - 6 have been checked 
                    with ref. to the bill vide page 224 of the Audit Manual.
                </td>
            </tr>
            <tr>
        ...
        <table width="95%" border="1" cellpadding="0" cellspacing="0" style="font-size:11px;" align="center">
            ...
            <tr style="height:80px;">
                <td colspan="6" style="border:1px solid black;" align="center">
                    ...
                    (in words) Rs ${showAmt}/- (RUPEES <b>${showAmtText}</b>) ONLY<br />Rs ${showAmt}/- (RUPEES <b>${showAmtText}</b>) ONLY by T.C to 8009 GPF of AEI
            </td>
            </tr>
        </table>
        <table width="80%" border="0" cellpadding="0" cellspacing="0" style="font-size:11px;" align="center">
