    ...
    <body>
        <div style="width:90%;margin: 0 auto;">
            <table width="100%" border="0">
                ...
                <tr>
                    <td colspan="2" style="text-align:center" class="printData">
                        <b> 0079-Loans to Govt. servants for construction of house-13072-Normal House Building Advance </b>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="text-align:center" class="printData">
        ...
        <c:if test="${not empty EmpInterestList}">        
            <div style="width:97%;margin: 0 auto;">
                <table width="100%" border="0">
                    ...
                    <tr>
                        <td colspan="2" style="text-align:center" class="printData">
                            <b> 0049-Interest Receipts of State/Union-Territory Governments-800-Other <br/> 
                                Receipts-0060-Interest Receipts-10019-Interest on Loans and advances to Govt.</br>
                                Servants-076-House Building Advance 
                            </b>
                        </td>
                    </tr>
                    <tr>
