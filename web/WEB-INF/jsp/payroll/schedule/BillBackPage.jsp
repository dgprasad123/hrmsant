                 ...
                 <table border="0" width="100%" cellpadding="0" cellspacing="0" style="font-size:16px">
                    ...
                    <tr style="height:50px">
                        <td colspan="4" align="center">
                            <br><br><br>
                            2ND DISCHARGE FOR RBI, PAD, BHUBANESWAR
                        </td>
                    </tr>
                    
                </table>
            </td>
            <td width="50%" class="borderTopandRight" style="font-size:12px;padding-left:4px">
                ...
                <br>
                <p style="font-weight:bold; text-align:right;padding-right:10px;"> RECEIVED PAYMENTS </p> 
