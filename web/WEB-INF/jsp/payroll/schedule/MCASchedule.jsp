...
<html>
            ...
            <c:forEach var="eachEmpMcaP" items="${EmpPrincpalList}">
                <tr style="height:30px">
                    <td width="4%" align="center" style="border-bottom:1px solid #000000;">&nbsp;
                        <c:if test="${eachEmpMcaP.slno > 0}">
                            <c:out value="${eachEmpMcaP.slno}"/>
                        </c:if>
                    </td>
    ...
    <div style="width:90%;margin: 0 auto;">
        <table width="100%" border="0">
            ...
            <tr>
                <td colspan="2" style="text-align:center" class="printData">
                    <b> 0049-Interest Receipts of State/Union-Territory Governments 800-Other Receipts-0060-Interest Receipts-10019
                        -Interest on Loans and advances to Govt. Servants-003-Advances for Purchase of Motor Conveyances </b>
                </td>
            </tr>
                ...
                <c:forEach var="eachEmpMcaI" items="${EmpInterestList}">
                    <tr style="height:30px">
                        <td width="5%" align="center" style="border-bottom:1px solid #000000;">
                            <c:if test="${eachEmpMcaI.slno > 0}">
                                <c:out value="${eachEmpMcaI.slno}"/>
                            </c:if>
                        </td>
                        <td width="20%" align="left" style="border-bottom:1px solid #000000;">&nbsp;
