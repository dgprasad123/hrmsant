                ...
                <div class="container-fluid">
                    ...
                    <div class="row"> 
                        <div class="col-sm-12 hide-on-screen">
                            <form:form action="GetLTAdvanceList.htm" commandName="ltAdvance" method="POST" onsubmit="return validate()">
                                <table border="0" width="80%" class="table" cellspacing="0" style="font-size:12px; font-family:verdana;">
                                    <tr>
                                        ...
                                        <td>
                                            <strong>Loanee ID:</strong>
                                            <form:input class="form-control" path="loaneeId" id="loaneeId"></form:input>
                                            </td>                                     
