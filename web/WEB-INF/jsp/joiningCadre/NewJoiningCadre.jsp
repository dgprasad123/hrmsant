...
<html>
    ...
    <body>
        <form:form action="saveJoiningCadre.htm" method="POST" commandName="joiningCadreForm">
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Employee Joining To Cadre
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            ...
                            <div class="col-lg-1">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#joiningCadreAuthorityModal">
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            <div class="col-lg-2">
                                <label for="sltPostGrp">Post Group<span style="color: red">*</span></label>
                            </div>
                            <div class="col-lg-2">
                                <form:select class="form-control" path="sltPostGrp" id="sltPostGrp">
                                    <form:option value="">--Select--</form:option>
                    ...
                    <div class="panel-footer">
                        <input type="submit" name="btnJoiningCadre" value="Save" class="btn btn-default" onclick="return saveCheck();"/>
                        <c:if test="${not empty joiningCadreForm.joiningCadreId}">
                            <input type="button" name="btnJoiningCadre" value="Delete" class="btn btn-default" onclick="return confirm('Are you sure to delete?');"/>
                        </c:if>
                    </div>
                </div>
            </div>

            <div id="joiningCadreAuthorityModal" class="modal" role="dialog">
