...
<html>
    ...
    <body>
        <form:form action="savePermission.htm" method="post" commandName="leavingForm" onsubmit="return saveCheck();">
            <div class="container-fluid">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form:hidden path="hidTempPostedFieldOffCode" id="hidTempPostedFieldOffCode"/>
                          ...
                          <div class="row" style="margin-bottom: 7px;">
                            <div class="col-lg-4">
                                <label for="chkNotSBPrintnew">Check Not to Print in Service Book</label>
                            </div>
                            <div class="col-lg-3">   
                                <form:checkbox path="chkNotSBPrintnew" value="Y" class="form-control"/>
                            </div>
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            ...
                            <div class="col-lg-2">
                                <div class="input-group date" id="processDate">
                                    <form:input class="form-control" path="ordt" id="ordt" readonly="true"/>
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            ...
                            <div class="col-lg-4">
                                <div class="input-group date" id="fdateTime">
                                    <form:input class="form-control" path="fdate" id="fdate" readonly="true"/>
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                </div>
                         ...
                         <div class="row" style="margin-bottom: 7px;">
                            ...
                            <div class="col-lg-4">
                                <div class="input-group date" id="edateTime">
                                    <form:input class="form-control" path="edate" id="edate" readonly="true"/>
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                </div>
                    ...
                    <div class="panel-footer">
                        <button type="submit" name="submit" value="Save" class="btn btn-default" onclick="return saveCheck();">Save Permission</button>
