...
<html>
    ...
    <body>
        <form:form action="saveDetention.htm" method="post" commandName="leavingForm" onsubmit="return saveCheck();">
            <div class="container-fluid">
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer">
                        <button type="submit" name="submit" value="Save" class="btn btn-default" onclick="return saveCheck();">SAVE DETENTION</button>
