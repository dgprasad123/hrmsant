...
<script type="text/javascript">
    ...
    function saveNOC() {
        ...
        if ($('#extensionReason').val() == '') {
            alert('Extesion Reason field should not be blank.');
            $('#extensionReason').focus();
            return false;
        }
...
<div class="container-fluid">
    <div align="center" style="margin-top:5px;margin-bottom:7px;">
        ...
        <div class="panel panel-primary" >
            <div class="panel-heading">Special Retention Request</div>
            <div class="panel-body" style='font-size:15px;min-height:400px'>
                ...
                <form:form autocomplete="off" role="form" action="#" commandName="EmpQuarterBean"  method="post"  class="form-horizontal" enctype="multipart/form-data" id="id_noc_upload_frm">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" >Reason of Extension :</label>
                        <div class="col-sm-4">
                           <form:textarea class="form-control" path="extensionReason" id="extensionReason" rows="3"  maxlength="250"/>
                         
                            
                            <br/>(Maximum 250 Characters)
                        </div>


                        <label class="control-label col-sm-2">Attach Supporting Document:</label>
                        <div class="col-sm-4">
