                ...
                <div class="container-fluid">
                    <form:form role="form" action="SaveVacationStatus.htm" commandName="EmpQuarterBean"  method="post" class="form-horizontal">
                        <div align="center" style="margin-top:5px;margin-bottom:7px;">
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body" style='font-size:15px;'>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" >Vacation Status:</label>
                                        <div class="col-sm-2">
                                            <input type="radio" id="NOCApproved" name="vacateStatus" value="Yes" onclick="radioClicked()"> <b>Vacated</b>
                                        </div>                                        
                                        <div class="col-sm-2">
                                            <input type="radio" id="NOCRejected" name="vacateStatus" value="No" onclick="radioClicked()">  <b>Not Vacated</b>
                                        </div>
                                    </div>
                                </div>
                            </div>

                            <div class="panel panel-success" id="id_intimation" style="display: none">
                            ...
                            <div class="panel panel-success" id="id_opp" style="display: none">
                                <div class="panel-heading"><strong>OPP requisition Generation</strong></div>
                                <div class="panel-body" style='font-size:15px;min-height:400px'>
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" for="orderNumber">Rent Order No:</label>
                                        <div class="col-sm-4">
                                            <form:input class="form-control" path="oPPorderNumber" id="oPPorderNumber" value="${orderNo}" readonly="true"/>
                                        </div>


                                        <label class="control-label col-sm-2" >Rent Order Date:</label>
                                        <div class="col-sm-4">
                                            <form:input class="form-control" path="oPPorderDate" id="oPPorderDate"  value="${orderdate}" readonly="true"/>                                            
                                        </div>
                                    </div>
                                    <div class="form-group">
