            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div align="center" style="margin-top:5px;margin-bottom:7px;">
                        <h2 class="text-info">View Quarter Details</h2>
                        <input type="hidden" name="tqrtrtype" id="tqrtrtype" value="${waterRent.qrtrtype}"/>
                        <form:form action="viewQuarterDetails.htm" method="POST" commandName="empQuarterBean">
                                    ...
                                    <tbody id="wrrgrid">
                                        <c:forEach items="${quarterList}" var="quarter" varStatus="cnt">
                                            ...
                                            <tr >
                                                ...
                                                <th>                                 
                                                        <a href="addoccupationQrtDetails.htm?qaId=${quarter.qaId}&nocStatus=N" class="text-danger">Occupation Qrts | </a> 
                                                        <a href="addvacationQrtDetails.htm?qaId=${quarter.qaId}&nocStatus=Y" class="text-info">Vacation Qrts</a> 
