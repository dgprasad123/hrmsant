        ...
        if (radioValue == "NOCApproved" || radioValue == "NOCRejected") {
            ...
            if (radioValue == "NOCApproved" ) {
                ...
                if ($("#uploadDocumentphd").val() == "") {
                    alert("Please upload the Water Clearance Document.");
                    return false;
                }
            ...
            if (files.length > 0) {
                ...
                $.ajax({
                    ...
                    processData: false,
                    contentType: false,
                    url: "saveWateruploadClearance.htm",
                    success: function (data) {
                        $(currentRow).parent().parent().remove();
                        $("#id_save_noc_btm").hide();
                        $("#success_message").show();
                        $("#success_message").html("<h2>Water Rent Clearance Submitted Successfully!!!<h2>")
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("#id_save_noc_btm").hide();
                        $("#success_message").show();
                        $("#success_message").html("<h2>Information Submitted Successfully!!!<h2>")
                        //$(".pensionModal").modal('hide');
                        //.ajax.reload();
                    }
                });
            ...
            alert("Please Choose Water Rent Clearance Status Radio Button");
            return false;
        }
...
<div class="container-fluid" style="padding-bottom: 125px;">
    <div class="panel panel-default">
        <div class="panel-heading">
            <div class="row">
                <div class="col-lg-12">
                    <h2 style="color:  #0071c5;" align="center">Water Rent Clearance Upload Panel</h2>
                </div>
            </div>
            ...
            <div class="panel-body">
                <form:form action="saveuploadNOC.htm"  method="POST" commandName="PensionNOCBean" enctype="multipart/form-data" id="id_noc_upload_frm">
                    ...
                    <div class="row" style="margin-bottom: 7px;">
                        <div class="col-lg-2">
                            <label for="fa">Water Clearance Status</label>
                        </div>
                        <div class="col-lg-4"> 
                            <input type="radio" id="NOCApproved" name="NOC" value="NOCApproved" onclick="radioClicked()"> <b>Water Clearance Issue</b>
                        </div>
                        <div class="col-lg-4">
                            <input type="radio" id="NOCRejected" name="NOC" value="NOCRejected" onclick="radioClicked()">  <b>Water Clearance Declined</b>
                        </div>                                                                    
                    </div>
