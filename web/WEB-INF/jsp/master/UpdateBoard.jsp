        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">                      
                        <form:form action="updateBoard.htm" commandName="university" method="post">
                            <form:hidden path="boardserialNumber" />
                            ...
                            <div class="row row-margin">
                                ...
                                <div class="col-sm-6">
                                    <form:input cssClass="form-control" path="boardName"  placeholder="Enter Board Name"/>
                                </div>
                            </div>  
                            ...
                            <div class="form-group col-sm-12" style="margin-top:20px">
                                ...
                                <div class="text-center col-sm-12" >     
                                    <input type="submit" class="btn btn-primary" name="action" value="Update Board"> 
