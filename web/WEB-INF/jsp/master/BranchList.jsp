    ...
    <head>
        ...
        <script type="text/javascript">
           function editBranch(branchcode) {
                $('#newBranch').modal('toggle');
                $.getJSON("editBranch.htm?branchcode=" + branchcode, function(data) {
                    
                    $('#hidBranchCode').val(data.branchcode);
                    //alert($('#hidBranchCode').val());
                    $('#mdlbranchname').val(data.mdlbranchname);
                    $('#mdlifsccode').val(data.mdlifsccode);
                    $('#mdlmicrcode').val(data.mdlmicrcode);
                }).done(function() {
            ...
            <div id="wrapper">
                ...
                <div id="page-wrapper">
                    <div class="container-fluid">
                        ...
                        <form:hidden id="hidBranchCode" path="hidBranchCode"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-50"> 
                                            <div class="pull-right"> 
                                                ...
                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#newBranch" onclick="createBranch()" style="width:150px">Add New Branch</button>                                        
                                            </div>
                                        </div>
                                    </div><br/>
                                    <tr class="header">
                                    ...
                                    <tbody>
                                        <c:forEach var="branchList1" items="${branch_list}" varStatus="count">
                                            <tr>
                                                ...
                                                <td><button type="button" class="btn btn-default" onclick="editBranch('${branchList1.branchcode}')"  style="width:50px">Edit</button></td> 
                                            </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content modal-lg">
                                    ...
                                    <table border="0" width="90%"  cellspacing="0" style="font-size:12px; font-family:verdana; alignment-adjust: central">
                                        <tr>
                                            <td style="text-align:left; font-size: 12px;padding-left:70px">
                                                ...
                                                <form:input path="mdlbranchname" id="mdlbranchname" class="form-control" size="width:100%"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:left; font-size: 12px;padding-left:70px">
                                                ...
                                                <td style="padding-right:20px">
                                                <form:input path="mdlifsccode" id="mdlifsccode" class="form-control" size="width:100%" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="text-align:left; font-size: 12px;padding-left:70px">
                                                ...
                                                <td style="padding-right:20px">
                                                <form:input path="mdlmicrcode" id="mdlmicrcode" class="form-control" size="width:100%"/>
                                            </td>
                                        </tr>
                            ...
                            <div class="modal-footer">
                                <input type="submit" name="submit" class="btn btn-default" style="width:70px" value="Save" onclick="javascript: blankfield()"/> 
