<%-- 
    Document   : BlockList
    Created on : 6 May, 2022, 11:51:19 AM
    Author     : Devikrushna
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function addCheck() {
                ...
                if ($('#distCode').val() == "")
                {
                    alert("Please select District and Search Block List");
                    $('#distCode').focus();
                    return false;
                }              
            }
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">                            
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-file"></i> Block List 
                                </li>                            
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <form:form action="BlockList.htm" commandName="block" method="post">
                            <div class="container">
                            ...
                            <div class="col-lg-12">
                                <h3 class="heading-color">Block List</h3>
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped" id="example">
                                        <thead>
                                            <tr>
                                                <th class="th-bg">Sl No</th>
                                                <th class="th-bg">Block Code</th>
                                                <th class="th-bg">Block Name</th>
                                                <th class="th-bg">Action</th>                                           
                                            </tr>
                                        </thead>
                                        <tbody>                                                                                        
                                                <c:forEach items="${blockList}" var="blk" varStatus="count">
                                                    <tr>
                                                        <td>${count.index + 1}</td>
                                                        <td>${blk.blockCode}</td>
                                                        <td>${blk.blockName}</td>
                                                        <td><a href="getBlockDetail.htm?blockCode=${blk.blockCode}">Edit</a></td>                                    
                                                    </tr>
                                                </c:forEach>                                        
                                        </tbody>
                                    </table>
                                ...
                                <div class="panel-footer" id="add-new">
                                    <a href="getBlockDetail.htm?stateCode=${block.stateCode}&distCode=${block.distCode}"><button type="button" class="btn btn-info" onclick="return addCheck()">Add New Block</button>  </a>
