        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">                      
                        <form:form action="updateQualification.htm" commandName="qualificationBean" method="post">
                            ...
                            <div class="row row-margin">
                                ...
                                <div class="col-sm-6">
                                    <form:input cssClass="form-control" path="qualification"  placeholder="Enter Qualification"/>
                                </div>
                            </div>  
                            ...
                            <div class="form-group col-sm-12" style="margin-top:20px">
                                ...
                                <div class="text-center col-sm-12" >     
                                    <input type="submit" class="btn btn-primary" name="action" value="Update Qualification"> 
