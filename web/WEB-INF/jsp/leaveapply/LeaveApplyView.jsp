...
//                });
            ...
            function forwardCheck() {
                if ($('#txtSancAuthority').val() == "") {
                    alert("Please select leave account dealing officer");
                    return false;
                }
            }
            function savecheck() {
            ...
            function saveCLCancelDetails() {
                ...
                $('#clForm').form('submit', {
                    url: 'saveEOCancelData.htm?hidTaskId=' + cancelTaskId,
    ...
    <body>
                    ...
                    <div id="tbl-container" class="easyui-panel" title="Leave View"  style="width:100%;overflow: auto;">
                        ...
                        <fieldset style="margin-bottom:5px;">
                            ...
                            <table cellpadding="5" border="0" style="font-size:12px; font-family:verdana;">
                                ...
                                <tr style="height: 40px" >                               
                                    ...
                                    <td colspan="3"><span><c:out  value="${leaveForm.initiatedOn}"/></span></td> 
                                </tr>
                                <tr style="height: 40px" >                               
                                    <td align="center"> <%=i++%>. </td>
                                    <td>Submitted To</td>
                                ...
                                <tr style="height: 40px" >                               
                                    ...
                                    <td >Type of Leave :</td> 
                                    <td colspan="3"><span>
                                            <c:out  value="${leaveForm.leaveType}"/>
                                            <c:out  value="${leaveForm.sltPartofday}"/>
                                        </span>
                                    </td> 
                                </tr>
                                <tr style="height: 40px">                               
                        ...
                        <c:choose>
                            <c:when test="${leaveForm.passString == 'Task'}">
                                    ...
                                    <table border="0"  cellpadding="5" cellspacing="0" width="100%" class="tableview" style="font-size:12px; font-family:verdana;">
                                        ...
                                        <tr>    
                                            ...
                                            <td width="80%" colspan="4">
                                                <input class="easyui-combobox" id="sltActionType" name="sltActionType" data-options="valueField:'statusId',textField:'statusName',data:[{statusName:'--Select--',statusId:''},{statusName:'Approve for Cancellation',statusId:'105'}],onSelect: function(rec){actionEvent(rec.statusId);}" style="width:300px;height:25px"  >
                                            </td>
                                        </tr>
                                        <tr height="40px">
                                            <td align="center" colspan="4">
                                                <input class="easyui-linkbutton c1" style="width:120px;height:40px" id="bt1" type="submit" name="TakeAction" value="TakeAction" onclick="return savecheck()"/>      
                                            </td>
                                        </tr>
                                    </table>
                                </c:if>
                                    ...
                                    <fieldset style="margin-bottom:5px;">
                                        ...
                                        <table border="0"  cellpadding="5" cellspacing="0" width="100%" class="tableview" style="font-size:12px; font-family:verdana;">
                                            ...
                                            <tr  height="40px">
                                                ...
                                                <td  >Note(if Any)</td>
                                                <td colspan="4">
                                                    <input class="easyui-textbox" type="textarea" name="txtauthnote" data-options="multiline:true"  styleId="txtauthnote" style="width:80%;height:60px;border:1px solid #000000;" labelPosition="top"  styleClass="textareacolor" maxlength="1000"/>                                                             
                                ...
                                <c:if test = "${leaveForm.statusId == '5' && leaveForm.hidAuthEmpId==leaveForm.hidIssuingAuthEmpId}">    
                                    <input type="hidden" name="sltActionType" id="sltActionType" value="6"/>
                                    <fieldset style="margin-bottom:5px;">
                                        <legend class="PortletLegendText">Action is to be taken</legend>
                                        <table border="0"  cellpadding="5" cellspacing="0" width="100%" class="tableview" style="font-size:12px; font-family:verdana;">
                                            ...
                                            <tr style="height: 40px" >                               
                                                <td align="center">3. </td>
                                                <td >Forward To Issuing Authority <br>(Leave Account Dealing officer):<span style="color: red"></span></td>                                                                                          
                                                <td colspan="4"><input class="easyui-textbox" id="txtSancAuthority" type="text" name="txtSancAuthority" style="width:400px;height:25px"  ></input>
                                            ...
                                            <tr  height="40px">
                                                <td align="center" colspan="4">
                                                    <input class="easyui-linkbutton c1" style="width:120px;height:40px" id="bt1" type="submit" name="TakeAction" value="TakeAction" onclick="return forwardCheck()"/>      
                                                </td>
                                            </tr>
                                        </table>
                                    </fieldset> 
                        ...
                        <div style="text-align:center;padding:5px">
                            ...
                            <c:if test = "${leaveForm.statusId == '5'}"> 
                                <input class="easyui-linkbutton c1" style="width:120px;height:40px;background:#FF0000" type="button" name="Cancel" value="Cancel" onclick="openCancelWindow()"/>&nbsp;&nbsp;
                                <input class="easyui-linkbutton c1" style="width:120px;height:40px" type="submit" name="Print" value="Print" />
                            </c:if>
                            <c:if test = "${leaveForm.statusId == '41'}"> 
                                <input class="easyui-linkbutton c1" style="width:120px;height:40px" type="submit" name="Print" value="Print" />
                            ...
                            <c:choose>
                                <c:when test="${leaveForm.passString == 'Own'}">
                                    ...
                                    <c:if test = "${leaveForm.statusId == '3'  && leaveForm.workFlowStatusId!='2'}">
                                        <input class="easyui-linkbutton c1" style="width:120px;height:40px" type="submit" name="cancel" value="Delete Leave" onclick="return confirm('Are you sure to cancel the leave?');"/>
                                    </c:if>
                                    <c:if test = "${leaveForm.statusId == '42'}">
                                        <input class="easyui-linkbutton c1" style="width:120px;height:40px" type="submit" name="cancel" value="Delete Leave" onclick="return confirm('Are you sure to cancel the leave?');"/>
                                    </c:if>
                                </c:when>
                            </c:choose>
        ...
        <div id="dlgCLCancelWindow" class="easyui-dialog" title="Leave Cancel Window" data-options="iconCls:'icon-save'" closed="true" style="width:50%;height:50%;top:5px;padding:5px 10px;font-size:12px; font-family:verdana;">
            <form id="clForm" method="post">
                ...
                <input type="hidden" id="cancelTaskId" value="${taskId}"/>
                ...
                <div style="margin-left:50px;padding:5px 0">
                    <span>From Date</span>
                    <span>
                        <input name="txtApproveFrom" id="txtApproveFrom" readonly="readonly" style="width:80px;" class="txtDate" value="${leaveForm.txtperiodFrom}"/>
                    </span>

                    <span>To Date</span>
                    <span>
                        <input name="txtApproveTo" id="txtApproveTo" readonly="readonly" style="width:80px;" class="txtDate" value="${leaveForm.txtperiodTo}"/>
                    </span>
                </div>
