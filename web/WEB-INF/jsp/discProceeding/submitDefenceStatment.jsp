...
<html>
    ...
    <body>
        <div id="page-wrapper">
            <form:form action="savedefence.htm" commandName="defencebean" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="container-fluid">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <p> ${dpviewbean.irrgularDetails}<br></p>
                        </div>
                    </div>
                    <div class="panel panel-default">
