<%-- 
    Document   : annexure2
    Created on : Jun 27, 2018, 11:42:57 AM
    Author     : manisha
--%>
                    ...
                    <div align="center" width="99%" style="margin-top:5px;margin-bottom:10px;height:55%;">
                        <div align="center" class="easyui-panel" title="IRREGULARITIES" width="99%">
                            <table border="0" width="99%">
                                ...
                                <tr>
                                    <td colspan="2" align="center" class="headr">Statement of Imputations<br><br></td>

                                </tr>
                                <tr>
                                    <td colspan="2" align="center" class="headr">[Annexure-II]<br><br></td>
                                </tr>
                            </table>
