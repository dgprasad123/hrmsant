...
<html>
    ...
    <body>
        ...
        <form:form action="forwardRule15DiscProceding.htm" method="POST" class="form-horizontal" commandName="ForwardDiscChargeBean">
            <form:hidden path="daId"/>
            <form:hidden path="processId"/>            

            <input type="hidden" id="tempPostCode" value="${tempPostCode}"/>
            <div class="panel panel-default">
                <div class="panel-heading">Forward Departmental Proceeding</div>
                ...
                <div class="panel-footer"><button type="submit" class="btn btn-default" onClick="getEmployee()">Search</button></div>
            </div>            
            <div class="panel panel-default">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><span style="font-weight: bold;">AUTHORITY NAME</span></th>
                                <th width="45%">post</th>
                            </tr>
                        </thead>
                        <tbody>                                        
                            <c:forEach items="${emplist}" var="emp" >
                                <tr>
                                    <td><input type="radio" name="applyTo" value="${emp.empid}-${emp.spc}"></td>
                                    <td>${emp.empname}</td>
                                    <td>${emp.spn}</td>
                                </tr>
                            </c:forEach>
