<%-- 
    Document   : memoDetails
    Created on : Jul 7, 2018, 11:32:06 AM
    Author     : manisha
--%>
                            ...
                            <table width="100%" border="0" style="font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 13px;">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        is here by informed that it is proposed to take Departmental Action against him/her under Rule 16 of the Orissa Civil Services (Classification, Control and Appeal)
                                ...
                                <tr>
                                    <td>
                                        3 If ${dpviewbean.gender} fails to submit his/her representation within 15 days of the receipt of this Memorandum, it will be presumed that he/she has no representation to submit and 
                            ...
                            <table width="100%" border="0" style="font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 13px;">
                                ...
                                <tr>
                                    <td>
                                        Copy Forwarded to 
                                            ...
                                            ${dpviewbean.initAuthName}, ${dpviewbean.initAuthCurDegn}
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <c:forEach items="${dpviewbean.delinquent}" var="delinquent">
                                            ${delinquent.doEmpName}, ${delinquent.doEmpCurDegn},${delinquent.officeName}  
                                        </c:forEach>
                                        <br><br><br>
