...
<html>
    ...
    <body>
        <form:form action="saveRedeployment.htm" method="POST" commandName="redeploymentForm">
            <div class="container-fluid">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            <div class="col-lg-2">
                                <label for="postedspn">Details of Redeployment<span style="color: red">*</span></label>
                            </div>
                            <div class="col-lg-9">
                                <form:input class="form-control" path="postedPostName" id="postedspn" readonly="true"/>                           
                            </div>
                            <div class="col-lg-1">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#redeploymentPostingModal">
                                    <span class="glyphicon glyphicon-search"></span> Search
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="panel-footer">
                        <input type="submit" name="btnPromotion" value="Save Redeployment" class="btn btn-default" onclick="return saveCheck();"/>
            ...
            <div id="redeploymentPostingModal" class="modal" role="dialog">
                <div class="modal-dialog">
                    <!-- Modal content-->
                    <div class="modal-content">
                        <div class="modal-header">
