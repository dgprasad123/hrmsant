...
<html>
    ...
    <body>
        <form:form action="assignAERWorkflowrouting.htm">
                    ...
                    <table width="70%" cellspacing="0" cellpadding="4" class="tblprocess">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="submit" name="btnval" value="Return" class="btn btn-primary btn-sm"/>
                            </td>
                        </tr>                        
                    </table>
                </div>
                    ...
                    <div class="left" style="float:left;width:49%;">
                        <ul class="source connected">
                            <li style="background:#890000;color:#FFFFFF;font-weight:bold;font-size:12pt;">Proposed List</li>
                                ...
                                <li>
                                    <c:out value="${proposeData.postName}"/>
                                    <a href="addAERWorkflowrouting.htm?assignedPostcode=${proposeData.reportingGpc}&postcode=${command.gpc}&processId=${command.processId}&departmentcode=${command.sltDept}&offCode=${command.sltOffcode}"> 
                    ...
                    <div class="right" style="float:right;width:49%;">
                        <ul class="target connected">
                            ...
                            <c:forEach var="assignedData" items="${assignedList}">
                                <li>
                                    <a href="removeAERWorkflowrouting.htm?workflowRoutingId=${assignedData.workflowRoutingId}&postcode=${command.gpc}&processId=${command.processId}&departmentcode=${command.sltDept}&offCode=${command.sltOffcode}"> <img src="images/arrow_l.png" style="margin-right:10px;" /></a><c:out value="${assignedData.postName}"/>
                                </li> 
                            </c:forEach>
                        </ul>
                    </div>
