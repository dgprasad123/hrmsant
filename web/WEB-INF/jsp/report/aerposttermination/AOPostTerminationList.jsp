...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function show_consolidated_report(){
              ...
              window.location="AOWiseSummaryReport.htm?fy="+fy;
    ...
    <body>
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="row">
                        <h3 align="center"> 
                            Financial Year <form:form action="AOViewPostTerminationList.htm" commandName="command">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:if test="${ not empty offlist.isAoApproved}">
                                            <a href="viewPostTerminationScheduleII.htm?propsalId=${offlist.proposalId}&financialYear=${financialYear}&type=1"/>View</a>
                                        </c:if>           
                                        ...
                                        <c:if test="${ empty offlist.isAoApproved}">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li> <a href="viewPostTerminationScheduleII.htm?propsalId=${offlist.proposalId}&financialYear=${financialYear}&type=1"/>View</a></li>  
        ...
        <form:form action="AOWiseTerminationStatus.htm" commandName="command">
