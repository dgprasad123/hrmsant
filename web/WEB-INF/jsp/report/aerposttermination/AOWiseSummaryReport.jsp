    ...
    <body>
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <form:form action="SubmitConsolidatedDataToFD.htm" method="POST" commandName="command">               
                    ...
                    <div class="panel-body">
                        ...
                        <c:if test="${status eq 'Y' && FDStatus eq 'N'}">     

                            <div class="modal-footer">
                                <button type="submit" name="btnPTAer" value="Send to Finance Department" class="btn btn-primary" onclick="return validateSend()">Send to Finance Department</button>
                            </div>             
                        </div>
                    </c:if> 
                     <c:if test="${ FDStatus eq 'Y'}">     

                            <div class="modal-footer">
                                <strong style='color:Red'>
                                  Post Termination Proposal Submitted to Finance Department  
