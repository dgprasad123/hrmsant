...
<html>
    ...
    <body>
        <form:form action="displayAERlistForAdministrativeAuthority.htm" method="POST" commandName="command">
            ...
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-footer">
                        ...
                        <c:if test="${showsubmitbtn eq 'Y'}">
                            <c:if test="${not empty command.aoOffCode}">
                                <button type="submit" name="btnAer" value="SubmitToFinanceMultipleAO" class="btn btn-primary" onclick="return confirm('Are you sure to Submit?')">Submit to Finance Department</button>
                            </c:if>
                            <c:if test="${empty command.aoOffCode}">
                                <button type="submit" name="btnAer" value="SubmitToFinance" class="btn btn-primary" onclick="return confirm('Are you sure to Submit?')">Submit to Finance Department</button>
                            </c:if>
                        </c:if>
                    </div>
                    <div class="panel-body">
                        ...
                        <table class="table table-striped table-bordered" width="90%">
                            ...
                            <tr>
                                ...
                                <td> &nbsp; </td>
                                <td> &nbsp; </td>
                                <td> <strong>${partAtotalGrpASanctionedStrength}</strong> </td>
                                <td> <strong>${partAtotalGrpAMenInPosition}</strong> </td>
                                <td> <strong>${partAtotalGrpAVacancy}</strong> </td>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td> &nbsp; </td>
                                <td> &nbsp; </td>
                                <td> <strong>${partATotalGrpBSanctionedStrength}</strong> </td>
                                <td> <strong>${partATotalGrpBMenInPosition}</strong> </td>
                                <td> <strong>${partATotalGrpBVacancy}</strong> </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td> &nbsp; </td>
                                <td> &nbsp; </td>
                                <td> <strong>${partATotalGrpCSanctionedStrength}</strong> </td>
                                <td> <strong>${partATotalGrpCMenInPosition}</strong> </td>
                                <td> <strong>${partATotalGrpCVacancy}</strong> </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td> &nbsp; </td>
                                <td> &nbsp; </td>
                                <td> <strong>${partATotalGrpDSanctionedStrength}</strong> </td>
                                <td> <strong>${partATotalGrpDMenInPosition}</strong> </td>
                                <td> <strong>${partATotalGrpDVacancy}</strong> </td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> &nbsp; </td>
                                    <td> &nbsp; </td>
                                    <td> <strong>${partBtotalGrpASanctionedStrength}</strong> </td>
                                    <td> <strong>${partBtotalGrpAMenInPosition}</strong> </td>
                                    <td> <strong>${partBtotalGrpAVacancy}</strong> </td>
                                    <td>&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td> &nbsp; </td>
                                    <td> &nbsp; </td>
                                    <td> <strong>${partBTotalGrpBSanctionedStrength}</strong> </td>
                                    <td> <strong>${partBTotalGrpBMenInPosition}</strong> </td>
                                    <td> <strong>${partBTotalGrpBVacancy}</strong> </td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td colspan="9"><h4> Group-C  </h4></td>
                                ...
                                <tr>
                                    ...
                                    <td> &nbsp; </td>
                                    <td> &nbsp; </td>
                                    <td> <strong>${partBTotalGrpCSanctionedStrength}</strong> </td>
                                    <td> <strong>${partBTotalGrpCMenInPosition}</strong> </td>
                                    <td> <strong>${partBTotalGrpCVacancy}</strong> </td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td colspan="9"><h4> Group-D </h4> </td>
                                ...
                                <tr>
                                    ...
                                    <td> &nbsp; </td>
                                    <td> &nbsp; </td>
                                    <td> <strong>${partBTotalGrpDSanctionedStrength}</strong> </td>
                                    <td> <strong>${partBTotalGrpDMenInPosition}</strong> </td>
                                    <td> <strong>${partBTotalGrpDVacancy}</strong> </td>
                                    <td>&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td> &nbsp; </td>
                                    <td> &nbsp; </td>
                                    <td> <strong>${giaTotalSanctionedStrength}</strong> </td>
                                    <td> <strong>${giaTotalMenInPosition}</strong> </td>
                                    <td> <strong>${giaTotalVacancy}</strong> </td>
                                    <td>&nbsp;</td>
                                </tr>
                            </tbody>
                        </table>             
