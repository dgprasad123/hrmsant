...
<html>
    <head>
        ...
        <script type="text/javascript" >
            ...
            function viewDuplicateEmp(dupPost) {
                var emplist = "";
                $('#dupSpcEmpList').empty();
                var url = 'viewDuplicateEmpJSON.htm?dupPostCode=' + dupPost;
                // alert(dupPost);
        ...
        <div id="pagecontent">
            <div class="container-fluid">
                <div class="panel panel-default">
                            ...
                            <tbody>
                                ...
                                <c:forEach items="${genericPostList}" var="genPost" varStatus="cnt">
                                    ...
                                    <tr id="idGpc" style="background: lightpink;">                                
                                        ...
                                        <c:if test="${genPost.meninPosition ne '0'}">
                                            <td id="btnMenInPosition" style="text-align: center;color: #000"><a href="gpcWiseemployeeList.htm?gpc=${genPost.dupGpc}" target="_blank">${genPost.meninPosition}</a></td>
                                            </c:if>
                                        <td style="text-align: center;color: #000">${genPost.vacancyPosition}</td>  
                                        <td style="text-align: center;color: #000">
                                            <a href="javascript:viewDuplicateEmp('<c:out value="${genPost.dupGpc}"/>')" />      
                                            <button type="button" style="width:50%;font-weight:bold" class="btn btn-primary" data-remote="false" data-toggle="modal" data-target="#viewDuplicateEmp" id="excludeExport" >View Duplicates</button>
                                            </a>
                                        </td>
                                    </tr>
                                </c:if>
                                <c:if test="${genPost.gpc != genPost.dupGpc}">
                                    <tr id="idGpc1"> 
                                        ...
                                        <c:if test="${genPost.meninPosition ne '0'}">
                                            <td id="btnMenInPosition1" style="text-align: center;color: #000"><a href="gpcWiseemployeeList.htm?gpc=${genPost.gpc}" target="_blank">${genPost.meninPosition}</a></td>
                                            </c:if>
                                        <td style="text-align: center;color: #000">${genPost.vacancyPosition}</td> 
                                        <td style="text-align: center;color: #000">
                                        </td>
                    ...
                    <div id="viewDuplicateEmp" class="modal fade" role="dialog">
