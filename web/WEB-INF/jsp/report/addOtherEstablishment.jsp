                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    ...
                                    <form:input path="otherPost" id="otherPost" class="form-control"/>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="inputPassword4">pay Scale (7th Pay)<strong style="color:red">*</strong></label>
                                    <form:input path="other7thPay" id="other7thPay" class="form-control"/>
                                </div>
                                <div class="form-group col-md-2">
                                    <label for="inputPassword4">Persons-in-Position<strong style="color:red">*</strong></label>
                                    <form:input path="otherSS" id="otherSS" onkeypress="return onlyIntegerRange(event)" class="form-control"/>
                                </div>
                                <div class="form-group col-md-2">
                                    <label for="inputPassword4">Remarks</label>
                                    <form:input path="otherRemarks" id="otherRemarks" class="form-control"/>
                                </div>
                            </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr class="bg-info text-white">
                                    ...
                                    <th>Pay Scale (AS per 7th Pay)</th>
                            ...
                            <tbody>
                                <c:forEach items="${aeDetails}" var="ae" varStatus="cnt">
                                    <tr>
                                        ...
                                        <td>${ae.otherSS}</td>                               
                                        <td><a href="editOtherEst.htm?aerOtherId=${ae.aerOtherId}&aerId=${ae.aerId}&partType=C"><span class="glyphicon glyphicon-pencil"></span>Edit</a>
                                            &nbsp;
                                            <a href=#" onclick="delete_otherEst(${ae.aerOtherId},${ae.aerId}, 'C')" ><span class="glyphicon glyphicon-remove"></span> Delete</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
