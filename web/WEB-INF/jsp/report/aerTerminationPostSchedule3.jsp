...
<html>
    ...
    <body>
        ...
        <form:form action="displayPostSchedule3.htm" method="POST" commandName="command" >
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped table-bordered" width="90%">
                            ...
                            <c:forEach var="partAGrpA" items="${PartAGrouplist}">
                                <tr>
                                    ...
                                    <td><input type="checkbox" name="chkReportId" value="${partAGrpA.reportId}" class="chkReportId" />  </td>
                        ...
                        <div class="p-3 mb-2 bg-danger text-white" style='color:white;background-color:red;height:50px;padding:5px'>
                            <div style='margin-top:10px'>
                                <input type="checkbox" name="chkReportId" value="NA" class="chkReportId" /> <strong>Click here if there is No POST Termination Proposal</strong>
                            </div>
                        </div>    
        ...
        <script>
            function validate() {
                var checkgpcvalue = $('.chkReportId:checkbox:checked').length;
                if (checkgpcvalue == 0) {
                    alert("Please select at least one checkbox for post termination");

                    return false;
                }
                 var checkedValue = $('.chkReportId:checkbox:checked').val();                
                if(checkedValue=="NA"){
