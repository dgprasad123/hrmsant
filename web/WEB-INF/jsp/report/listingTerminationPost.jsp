...
<html>
    ...
    <body>
        ...
        <form:form action="listingTerminationPost.htm" method="POST" commandName="command">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped table-bordered" width="90%">
                            ...
                            <c:forEach var="partAGrpA" items="${PartAGrouplist}"  varStatus="theCount">
                                <c:set var="nopost" value="${partAGrpA.notermPOst}"/>
                                <tr>
                                    ...
                                    <c:if test="${partAGrpA.notermPOst eq 'Y'}">
                                        <td><strong style='color:red'>No POST Termination Proposal</strong>
                                         &nbsp; <a href="downloadPDFScheduleIA.htm?termId=${partAGrpA.termId}&financialYear=${financialYear}"/><span class="fa fa-file-pdf-o" style="color:red"> </span> &nbsp;SCHEDULE I-A</a>
                                        </td>
                                    </c:if>
                                    <c:if test="${empty partAGrpA.notermPOst }">
                                        <td><a href="viewTerminationPOstSchedule1.htm?termId=${partAGrpA.termId}&financialYear=${financialYear}">View</a>
                                         &nbsp; <a href="downloadPDFScheduleIA.htm?termId=${partAGrpA.termId}&financialYear=${financialYear}"/><span class="fa fa-file-pdf-o" style="color:red"> </span> &nbsp;SCHEDULE I-A</a>
                                        </td>
                                    </c:if>    
                        ...
                        <c:if test="${cntRecord eq '0'}">
                            <div class="modal-footer">
                                <a href="aerTerminationPost.htm?financialYear=${financialYear}"><button type="button" class="btn btn-primary" >Add New</button></a>
                            </div>
                        </c:if>    
                    </div>
