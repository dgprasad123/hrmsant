                            ...
                            <c:if test="${not empty emplist}">
                                ...
                                <c:forEach items="${emplist}" var="list" varStatus="count">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="ViewSupperannuationProjectionReportEmpWise.htm?officeCode=${list.offCode}&month=${month}&year=${year}&officeName=${list.departmentname}" target="_blank"><c:out value="${list.departmentname}"/></a>
                                        </td>
                                        <td>
