<%-- 
    Document   : AerReportPartB
    Created on : Jul 6, 2019, 3:59:57 PM
    Author     : Manas
--%>
...
<html>
    ...
    <body>
        ...
        <form:form action="createAERPartB.htm" method="POST" commandName="command">
                        ...
                        <table class="table table-bordered table-hover table-striped">
                            <thead>
                                <tr style="height:45px">
                                    ...
                                    <th style="font-size: 16px; font-weight:bold;">Office Name</th>
                                    <th style="font-size: 16px; font-weight:bold;">Office Code</th>
                                    <th style="font-size: 16px; font-weight:bold;">Edit</th>   
                                    <th style="font-size: 16px; font-weight:bold;">AER</th> 
                                </tr>
                            </thead>
                            <tbody>                                        
                                <c:forEach items="${officeList}" var="office" varStatus="count">
                                    <tr style="height:45px">
                                        <td style="font-size: 16px; font-weight:bold; background-color: #0056b3;color: #ffffff; ">${count.index + 1}</td>
                                        <td style="font-size: 16px; font-weight:bold; background-color: #0056b3;color: #ffffff; ">${office.offName}</td>
                                        <td style="font-size: 16px; font-weight:bold; background-color: #0056b3;color: #ffffff; ">${office.offCode}</td>
                                        <td style="font-size: 16px; font-weight:bold; background-color: #0056b3;color: #ffffff; "><a style="color: #ffffff;" href="getGranteeDetail.htm?offCode=${office.offCode}&aerId=${aerId}">Edit</td>

                                        <td style="font-size: 16px; font-weight:bold; background-color: #0056b3;color: #ffffff; "><a  style="color: #ffffff;" href="granteeofficewiseAer.htm?offCode=${office.offCode}&aerId=${aerId}">Manage AER</td>
                                    </tr>
                                    <tr>
                                        <td colspan="5">
                                    ...
                                    <c:forEach items="${office.aerPostData}" var="postdata" varStatus="cnt">



                                        <tr>
                                            <td> ${postdata.group} </td>
                                            <td> ${postdata.otherPost}&nbsp; </td>
                                            <td> ${postdata.scaleofPay} </td>
                                            <td> ${postdata.gp} </td>
                                            <td> ${postdata.other7thPay} </td>
                                            <td> ${postdata.otherSS} </td>
                                            <td> ${postdata.meninPosition} </td>
                                            <td> ${postdata.otherVacancy} </td>
                                            
                                            <td>
                                                ${postdata.otherRemarks}
                                            </td>
                                        </tr>
                                    </c:forEach>
                            </table>
