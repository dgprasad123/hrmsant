<%-- 
    Document   : partD_other
    Created on : 18 May, 2019, 12:38:26 PM
    Author     : Surendra
--%>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <form:select path="otherCategory" class="form-control" id="otherCategory" >
                                            ...
                                            <form:option value="Wages Establishment">Wages Establishment (Engineering Department)</form:option>
                            ...
                            <tbody>
                                <c:forEach items="${aeDetails}" var="ae" varStatus="cnt">
                                    <tr>
                                        ...
                                        <td>  <c:if test="${Submittedstatus eq 'true'}">
                                                <a href="editOtherEst.htm?aerOtherId=${ae.aerOtherId}&aerId=${ae.aerId}&partType=D"><span class="glyphicon glyphicon-pencil"></span>Edit</a>
                                                &nbsp;
                                                <a href=#" onclick="delete_otherEst(${ae.aerOtherId},${ae.aerId}, 'D')" ><span class="glyphicon glyphicon-remove"></span> Delete</a>
                                            </c:if>&nbsp;
                                        </td>
                                    </tr>
                                </c:forEach>
