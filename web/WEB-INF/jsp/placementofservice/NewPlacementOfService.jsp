...
<html>
    ...
    <body>
        <form:form action="savePlacementOfService.htm" method="POST" commandName="placementOfServiceForm">
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Employee Placement of Service
                    </div>
                    ...
                    <div class="panel-footer">
                        <a href="PlacementOfServiceList.htm"> <button type="button" class="btn btn-warning btn-md"> &laquo; Back</button></a>
                        <input type="submit" name="btnConfirmation" value="Save" class="btn btn-default" onclick="return saveCheck();"/>
                        <c:if test="${not empty placementOfServiceForm.hnotid}">
