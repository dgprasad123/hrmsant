    ...
    <head>
        ...
        <script  type="text/javascript">
            ...
            function group_wise_report() {
                ...
                self.location = 'totalsummaryvacantgroupwise.htm?month=' + month + '&year=' + year;
            }
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row" style="min-height:600px">
                            <div class="col-lg-12">
                                ...
                                <c:if test = "${misStatus eq 'Y'}">
                                    <c:set var = "TextValue" value = "01.06.2019"/> 
                                    <c:set var = "TextValue1" value = "No Of Posts cleared after 01.06.2019 "/> 
                                     <c:set var = "TextValue2" value = "No Of  cleared Post Prior to 01.06.2019"/> 
                                </c:if>
                                <c:if test = "${misStatus eq 'N'}">
                                    <c:set var = "TextValue" value = "01.04.2013"/> 
                                      <c:set var = "TextValue1" value = "No Of Posts cleared by F.D/E.C after 01.04.2013 "/> 
                                     <c:set var = "TextValue2" value = "No Of Backlog Vacant Post Prior to 01.04.2013"/> 
                                </c:if>
                                <form:form role="form" action="summarydeptVacantPostList.htm" commandName="deptVacantPostList"  method="post">
                                    ...
                                    <table width="100%" cellspacing="1" cellpadding="4" border="0" bgcolor="#EAEAEA" class="form-table" style="border:1px solid #CCCCCC;" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <Select name="month" id='month' class="form-control" required="1">
                                                ...
                                                <td>
                                                    <Select name="year" id='year'  class="form-control" required="1">
                                            ...
                                            <tr>
                                                <td colspan="4" align="center"><input type="submit" class="btn btn-primary" value="Submit"  />&nbsp;<input type="button" class="btn btn-primary" value="Group Wise Report"  onclick="group_wise_report()"/></td>
                                            </tr>
                                        </table>
                                        <!-- /.box-body -->
