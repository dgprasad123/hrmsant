    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
             ...
             <li>
            <li>
                <a href="ViewSupperannuationReport.htm" target="_blank"><i class="fa fa-fw fa-edit"></i>Superannuation Report</a>
            </li>
            <li>
                <a href="PersonnelISection.htm"><i class="fa fa-fw fa-edit"></i>Personnel Section</a>
            </li>          
           
            <li>
                <a href="viewStatisticalCellOfcList.htm" target="_blank"><i class="fa fa-fw fa-edit"></i>Statistical Report Office Wise</a>
            </li>
            <li>
