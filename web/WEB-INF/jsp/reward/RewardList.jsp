...
<html>
    ...
    <body>
        <form:form action="newReward.htm" method="post" commandName="rewardForm">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <c:forEach items="${rewardlist}" var="tlist">
                                    <tr>
                                        <td>${tlist.doe}</td>
                                        <td>${tlist.ordno}</td>
                                        <td>${tlist.ordt}</td>
                                        <td>${tlist.notType}</td>
                                        <td>
                                            <a href="editReward.htm?rewardId=${tlist.rewardId}&notId=${tlist.hnotid}">Edit</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                    ...
                    <div class="panel-footer">
                        ...
                        <button type="submit" class="btn btn-primary">New Reward</button> 
