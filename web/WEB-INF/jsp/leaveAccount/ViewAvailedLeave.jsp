        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    <input type="button" value="&laquo; Back to Availed Joining Time List" class="btn btn-default" style="background:#0076AA;color:#FFFFFF;" onclick="self.location = 'AvailedLeaveList.htm'" />
                </div>
            </div>
        </div>
