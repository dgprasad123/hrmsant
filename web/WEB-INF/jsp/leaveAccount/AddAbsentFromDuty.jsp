...
<html>
    ...
    <body>
        <form:form action="saveAbsentFromDuty.htm" method="post" commandName="MiscLeaveForm">
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <strong style="font-size:14pt;">Absent from Duty</strong>
                    </div>
...
<div class="row" style="margin-bottom: 7px;">
                            <div class="col-lg-12">
                                <label for="spc" style="color:#0081B7">Period of Absent from Duty</label>
                            </div>
                       </div>
                        <div class="row" style="margin-bottom: 7px;">
                            <div class="col-lg-2">
                    ...
                    <div class="panel-footer">
                        ...
                        <input type="button" value="Cancel" class="btn btn-default" onclick="self.location='AbsentFromDutyList.htm'" />
                    </div>
                </div>
            </div>
