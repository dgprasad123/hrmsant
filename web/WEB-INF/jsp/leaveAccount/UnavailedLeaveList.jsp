...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function confirmDelete(leaveId, notificationId)
            {
                ...
                {
                    $.ajax({
                    url: 'DeleteUnavailedLeave.htm',
                    type: 'get',
                    data: 'leaveId='+leaveId+'&notId='+notificationId,
                    success: function(retVal) {
                        self.location = 'UnavailedLeaveList.htm';
                    }
                });
    ...
    <body>
        <form:form action="AddUnavailedLeave.htm" method="post" commandName="MiscLeaveForm">
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-lg-12">
                                <h1 style="font-size:15pt;margin:0px;">Unavailed Joining Time</h1>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                <c:forEach items="${leaveList}" var="tlist">
                                    <tr>
                                        ...
                                        <td>${tlist.toDate}</td>
                                        <td align="center"><a href="viewUnavailedLeave.htm?leaveId=${tlist.leaveId}&notId=${tlist.notificationId}">View</a></td>
                                        <td align="center">
                                            <c:if test="${tlist.isValidated eq 'N'}">
                                                <a href="editUnavailedLeave.htm?leaveId=${tlist.leaveId}&notId=${tlist.notificationId}">Edit</a>
                                            </c:if>
                                        </td>
                    ...
                    <div class="panel-footer">
                        ...
                        <button type="button" class="btn btn-default" onclick="self.location='AddUnavailedLeave.htm'">Add New</button>  
                    </div>
                </div>
            </div>
        </form:form>
