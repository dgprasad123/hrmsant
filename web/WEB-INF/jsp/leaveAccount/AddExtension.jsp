...
<html>
    ...
    <body>
        <form:form action="saveExtension.htm" method="post" commandName="MiscLeaveForm">
...
<div class="row" style="margin-bottom: 7px;">
                    ...
                    <div class="panel-footer">
                        ...
                        <input type="button" value="Cancel" class="btn btn-default" onclick="self.location='ExtensionList.htm'" />
                    </div>
                </div>
            </div>
