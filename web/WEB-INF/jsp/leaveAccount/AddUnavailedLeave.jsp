...
<html>
    ...
    <body>
        <form:form action="saveUnavailedLeave.htm" method="post" commandName="MiscLeaveForm">
            <div class="container-fluid">
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer">
                        ...
                        <input type="button" value="Cancel" class="btn btn-default" onclick="self.location = 'UnavailedLeaveList.htm'" />
                    </div>
                </div>
            </div>
