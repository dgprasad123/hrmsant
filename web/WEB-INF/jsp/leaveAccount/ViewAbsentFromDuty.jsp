        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    <input type="button" value="&laquo; Back to Absent from Duty List" class="btn btn-default" style="background:#0076AA;color:#FFFFFF;" onclick="self.location = 'AbsentFromDutyList.htm'" />
                </div>
            </div>
        </div>
