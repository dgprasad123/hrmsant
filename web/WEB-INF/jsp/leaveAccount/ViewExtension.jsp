        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong style="font-size:14pt;">Extension Joining Time</strong>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row" style="margin-bottom: 7px;">
                        <div class="col-lg-12">
                            <label for="spc" style="color:#0081B7">Period of Extension Joining Time</label>
                        </div>
                    </div>
                    <div class="row" style="margin-bottom: 7px;">
                        <div class="col-lg-2">
                ...
                <div class="panel-footer">
                    <input type="button" value="&laquo; Back to Extension Joining Time List" class="btn btn-default" style="background:#0076AA;color:#FFFFFF;" onclick="self.location = 'ExtensionList.htm'" />
                </div>
            </div>
        </div>
