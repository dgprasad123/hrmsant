...
<html>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                /*
                 ...
                 $('#txtNextIncrementDt').datetimepicker({
                 format: 'D-MMM-YYYY',
                 useCurrent: false,
                 ignoreReadonly: true
                 });*/
            ...
            function cloneRow() {
                ...
                /*var rdoPaycomm = $("input[name='rdoPaycomm']:checked").val();
                 alert("rdoPaycomm is: " + rdoPaycomm);
                 //var $radios = $('input:radio[name=retroIncrement['+(num-1)+'].rdoPaycomm]');
                 if (rdoPaycomm == '6' || rdoPaycomm == '5') {
                 $("#paycomsix" + num).show();
                 $("#paycomseven" + num).hide();
                 //$radios.filter('[value=6]').prop('checked', true);
                 $("#rdoincrsixPaycomm" + num).prop('checked', true);
                 } else {
                 alert("#paycomseven" + num);
                 $("#paycomsix" + num).hide();
                 $("#paycomseven" + num).show();
                 //$radios.filter('[value=7]').prop('checked', true);
                 $("#rdoincrsevenPaycomm" + num).prop('checked', true);
                 }*/
    ...
    <body>
        <form:form action="savePayFixation.htm" method="POST" commandName="payFixation">
            <div class="container-fluid">
                <div class="panel panel-default">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-3">
                                    <form:select path="sltPayFixationReason" id="sltPayFixationReason" class="form-control">
                                        ...
                                        <form:option value="4th DACP">4th DACP</form:option>
                    ...
                    <div class="panel-footer">
                        ...
                        <%--</c:if>--%>
                        <c:if test="${empty isEmployeeRegular || isEmployeeRegular ne 'Y'}">
