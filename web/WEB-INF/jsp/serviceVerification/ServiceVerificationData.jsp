<%-- 
    Document   : ServiceVerificationData
    Created on : 20 Jul, 2018, 3:52:58 PM
    Author     : Surendra
--%>
...
<html>
    ...
    <body>
        <form:form action="addServiceVerificationDataController.htm" method="POST" commandName="command">
            <div class="container-fluid">
                <div class="panel panel-default">
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            ...
                            <div class="col-lg-3">   
                                <div class="input-group date" id="txtfdate1">
                                    <form:input class="form-control" path="txtfdate" id="txtfdate" readonly="true"/>
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            ...
                            <div class="col-lg-3">   
                                <div class="input-group date" id="txttdate1">
                                    <form:input class="form-control" path="txttdate" id="txttdate" readonly="true"/>
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                </div>     
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            ...
                            <div class="col-lg-3">   
                                <div class="input-group date txtDate">
                                    <form:input class="form-control" path="txtVerifiedOn" id="txtVerifiedOn" readonly="true"/>
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                </div>     
                    ...
                    <div class="panel-footer">
                        ...
                        <c:if test="${not empty command.txtsvid}">
                        ...
                        <c:if test="${not empty duplicate && duplicate eq 'Y'}">
                            <span style="font-weight: bold;font-size:15px; color: #F00000;">
                                DUPLICATE PERIOD
                            </span>
                        </c:if>
                    </div>
        ...
        <script type="text/javascript">
            $(function() {
                $('#txtfdate1').datetimepicker({
                    format: 'D-MMM-YYYY',
                    useCurrent: false,
                    ignoreReadonly: true
                });

                $('#txttdate1').datetimepicker({
                    format: 'D-MMM-YYYY',
                    useCurrent: false,
                    ignoreReadonly: true
                });
