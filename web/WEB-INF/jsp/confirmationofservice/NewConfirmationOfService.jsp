...
<html>
    ...
    <body>
        <form:form action="saveConfirmationOfService.htm" method="POST" commandName="confirmationOfServiceForm">
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Employee Confirmation of Service
                    </div>
                    ...
                    <div class="panel-footer">
                        <a href="ConfirmationOfServiceList.htm"> <button type="button" class="btn btn-warning btn-md"> &laquo; Back</button></a>
                        <input type="submit" name="btnConfirmation" value="Save" class="btn btn-default" onclick="return saveCheck();"/>
                        <c:if test="${not empty confirmationOfServiceForm.hnotid}">
