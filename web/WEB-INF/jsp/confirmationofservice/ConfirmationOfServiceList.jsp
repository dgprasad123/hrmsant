...
<html>
    ...
    <body>
        <form:form action="newConfirmationOfService.htm" method="post" commandName="confirmationOfServiceForm">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <c:forEach items="${confirmationOfServiceList}" var="clist">
                                    <tr>
                                        <td>${clist.doe}</td>
                                        <td>${clist.ordno}</td>
                                        <td>${clist.ordt}</td>
                                        <td>${clist.notType}</td>
                                        <td>
                                            <a href="editConfirmationOfService.htm?notId=${clist.hnotid}">Edit</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
                    ...
                    <div class="panel-footer">
                        ...
                        <button type="submit" class="btn btn-default">New Confirmation of Service</button>  
                    </div>
                </div>
            </div>
        </form:form>
