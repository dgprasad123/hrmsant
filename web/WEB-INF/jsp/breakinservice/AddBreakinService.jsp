...
<html>
    ...
    <body>
        <form:form action="saveBreakinService.htm" method="post" commandName="BreakinserviceBean">
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <strong style="font-size:14pt;">Employee Break in Service</strong>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            <div class="col-lg-2">
                                <label for="spc">Details of Sanctioning Authority <span style="color: red">*</span></label>
                            </div>
                            <div class="col-lg-9">
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            <div class="col-lg-2">
                                <label for="duration" style="font-size:14pt;">Period of Break:</label>
                            </div>
                        </div>

                        <div class="row" style="margin-bottom: 7px;">
                            <div class="col-lg-2">
                                <label for="durationFrom">Date From:<span style="color: red">*</span></label>
                            </div>
                            <div class="col-lg-2">
                                <div class='input-group date' id='processDate'>
                            ...
                            <div class="col-lg-2">
                                <label for="durationTo">Date To:</label>
                            </div>
                            <div class="col-lg-2">
                                <div class='input-group date' id='processDate'>
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            ...
                            <div class="col-lg-9">
                                <form:input class="form-control" path="noofDays" id="noofDays" style="width:200px;"/>
                            </div>
                            <div class="col-lg-1">
                            </div>
                        </div>
                    ...
                    <div class="panel-footer">
                        <button type="submit" name="submit" value="Save" class="btn btn-default" onclick="return saveCheck();">Save Break in Service</button>
                        ...
                        <input type="button" value="Cancel" class="btn btn-default" onclick="self.location = 'BreakinServiceList.htm'" />
                    </div>
                </div>
            </div>
