<%-- 
    Document   : AllowedToOfficiateData
    Created on : Apr 23, 2021, 2:57:02 PM
    Author     : Madhusmita
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function saveCheck() {
                ...
                if ($('#sltCadre').val() == "") {
                    alert("Please enter Name of the Cadre");
                    return false;
                }
                if ($('#txtCadreJoiningWEFDt').val() == "") {
                    alert("Please enter Date of Effect of Joining in Cadre / Post");
                    return false;
                }
                if ($('#sltCadreJoiningWEFTime').val() == "") {
                    alert("Please enter Time of Joining");
                    return false;
                }
                return true;
            }
    ...
    <body>
        <form:form action="saveOfficiation.htm" method="POST" commandName="allowedToOfficiateForm">
            <div class="container-fluid">
                <div class="panel panel-default">
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            ...
                            <div class="col-lg-8">
                                <form:select path="sltGenericPost" id="sltGenericPost" class="form-control">
                                    <form:option value="">--Select--</form:option>
                                    <form:options items="${genpostlist}" itemValue="postcode" itemLabel="post"/>
                                </form:select>
                            </div>
                            <div class="col-lg-1">
                    ...
                    <div class="panel-footer">
                        <input type="submit" name="btnSaveOfficiation" value="Save" class="btn btn-default btn-lg" onclick="return saveCheck();"/>
                        <a href="allowedToOfficiationList.htm"><input type="button" name="btnClose" value="Cancel" class="btn btn-default btn-lg"/></a>
                    </div>
                </div>
            </div>
