    ...
    <head>
        ...
        <script language="javascript1.2" type="text/javascript">
            $(document).ready(function () {
                ...
                // $('#dgleaveauthority').datagrid('hideColumn', 'empId');
            ...
            function img(value) {
                 var selspc = value.split(':');
                  var authspc=selspc[0];
                 var appspc=selspc[1];
                
                var url = "deleteSancAuth.htm?authSpc=";
                return '<a href="' + url + authspc +'&applicantSpc='+appspc+'">' + '<img src="images/Delete-icon.png" />' + '</a>';
            }
                            ...
                            <table id="dgleaveauthority" class="easyui-datagrid" style="width:100%;height:360px;" title="My Leave"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th  data-options="field:'spc'" formatter="img" width="15%">Remove</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
