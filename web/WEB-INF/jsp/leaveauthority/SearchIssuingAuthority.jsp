        ...
        <script language="javascript1.2" type="text/javascript">
            $(document).ready(function() {
                ...
                $('#dgleaveauthority').datagrid({
                    url: 'SelectIssuingAuthorityAction.htm',
                    method: 'post'
                });
            });
            function img(value) {
                var url = "deleteSelectedEmp.htm?empidid=";
                return '<a href="' + url + value + '">' + '<img src="images/Delete-icon.png" />' + '</a>';
            }
            ...
            function SelectPost() {
                ...
                var desg = radspl[2];
                var spc = radspl[3];
                 parent.SelectIssuingSpn(empId, name, desg, spc);
            }
        </script>
    </head>
    <body >
        <form:form  action="leaveissuingauthority.htm" method="POST" commandName="leaveAuthorityForm">
                            ...
                            <table id="dgleaveauthority" class="easyui-datagrid" style="width:100%;height:360px;" title="My Leave"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-options="field:'name'" width="40%">Name of the Employee1</th>
                                        <th data-options="field:'designation'" width="40%">Substantive Post</th>
                                        <th  data-options="field:'empId'" formatter="img" width="15%">Remove</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
            ...
            <div id="toolbar">
                <input class="easyui-linkbutton c1" type="submit" name="Search" value="Search"/>
            </div>
        </form:form>
    </body>
</html>
