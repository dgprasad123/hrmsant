                ...
                <div align="center">
                    <table border="0" cellspacing="0" cellpadding="0" style="width:100%">
                        <tr style="height: 40px" >    
                            ...
                            <td width="70%"><input class="easyui-combobox"  id="sltDept" name="sltDept" data-options="valueField:'value',textField:'label'"  style="width:70%;height:25px"></td> 
                            <td width="10%">&nbsp;</td>
                        </tr>
                        <tr style="height: 40px" >    
                            <td width="20%" align="center">Select Office:</td>
                            <td width="70%"><input class="easyui-combobox"  id="sltOffice" name="sltOffice" data-options="valueField:'value',textField:'label'"  style="width:70%;height:25px"></td> 
                            <td width="10%">&nbsp;</td>
                        </tr>
                        <tr style="height: 40px" >    
