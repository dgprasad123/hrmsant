                                                ...
                                                <div class="panel-heading">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <h4 style="color:  #0071c5;" align="center"><strong> <u>DDO Wise Sanctioned Strength Post List of <c:out value="${officename}"/>(POST GROUP-<c:out value="${postgroup}"/>)</u></strong></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <table class="table table-bordered table-hover table-striped">
                                                            <thead>
                                                                <tr style="background-color: #0071c5;color: #ffffff;">
                                                                    <th>Sl No</th>
                                                                    <th>Post Name</th>
                                                                    <th>Sanctioned Strength Position</th>
                                                                </tr>
                                                            </thead>                                     
