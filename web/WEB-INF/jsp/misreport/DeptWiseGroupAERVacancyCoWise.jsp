                                                ...
                                                <div class="panel-heading">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <h4 style="color:  #0071c5;" align="center"><strong> <u>VACANCY (Both Plan & Non-Plan)</u></strong></h4>
                                                        </div>
                                                    </div>
                                                    <form:form action="DeptWiseGroupAERVacancyCoWise.htm" method="POST" commandName="command">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                            ...
                                                            <table class="table table-bordered table-hover table-striped">
                                                                ...
                                                                <c:forEach items="${AERDetails}" var="bgroup" varStatus="count">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="viewCODeptWiseVacancy.htm?deptCode=${bgroup.deptCode}&fy=${financialYear}" target="_blank">${bgroup.departmentname}</a>
                                                                        </td>
