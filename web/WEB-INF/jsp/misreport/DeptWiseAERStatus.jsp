                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" align="center" style="background-color: #868686;color: #ffffff;font-size: xx-large;">                            
                            Department Wise AER Report(Fy:<c:out value="${fiscalyear}"/>)
                        </div>
                        ...
                        <div class="panel-body">
                            <div style="margin-bottom: 10px;">
                                <form:form action="DeptWiseAERStatus.htm" method="POST" commandName="command">
                                    <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <c:forEach items="${AERDetails}" var="bgroup" varStatus="count">
                                            ...
                                            <tr>
                                                <td>${count.index + 1}</td>
                                                <td><a href="DDOWiseAERStatus.htm?dcode=${bgroup.deptCode}" target='blank'>${bgroup.departmentname}</a></td>
