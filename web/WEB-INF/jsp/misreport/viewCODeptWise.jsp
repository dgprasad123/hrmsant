                                                ...
                                                <div class="panel-heading">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <h4 style="color:  #0071c5;" align="center"><strong> <u>CO Wise Report Details of <c:out value="${deptname}"/></strong></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered table-hover table-striped">
                                                                ...
                                                                <c:forEach items="${AERDetails}" var="bgroup" varStatus="count">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <c:if test="${bgroup.coStatus eq 'Y'}">
                                                                            <td>
                                                                                <%--<a href="viewCODeptWiseMIP.htm?deptCode=${bgroup.offCode}&aerId=${bgroup.aerId}" target="_blank">${bgroup.offName}</a>--%>
                                                                                <a href="viewDDODeptWiseSancStrength.htm?offCode=${bgroup.offCode}&aerId=${bgroup.aerId}" target="_blank">${bgroup.offName}</a>
                                                                            </td>
                                                                        </c:if>
                                                                        ...
                                                                        <c:if test="${bgroup.coStatus eq 'Y'}">
                                                                            ...
                                                                            <td><a href="downloadaerPDFReportForScheduleII.htm?aerId=${bgroup.aerId}"><span class="glyphicon glyphicon-file"></span></a>&nbsp;
                                                                                <a href="viewCODeptWiseMIP.htm?deptCode=${bgroup.offCode}&aerId=${bgroup.aerId}" target="_blank">Details</a>
                                                                            </td>
                                                                        </c:if>
                                                                    </tr>
                                                                </c:forEach>
                                                                <tr>
                                                                    ...
                                                                    <td><c:out value="${AllgrandTotalAll}"/></td>
                                                                    <td>&nbsp;</td>
                                                                    <td>&nbsp;</td>
                                                                </tr>
                                                            </table>
