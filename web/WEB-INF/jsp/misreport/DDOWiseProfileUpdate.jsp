            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" align="center" style="background-color: #868686;color: #ffffff;font-size: xx-large;">DDO Wise Employee Profile Updation  Report</div>
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <c:forEach items="${DDOProfileDetails}" var="bgroup" varStatus="count">
                                           ...
                                           <c:set var="GtotalComp" value="${GtotalComp + bgroup.totalCompleted}" />
                                            ...
                                            <tr>
                                                <td>${count.index + 1}</td>
                                                <td><a href="EmpwiseprofileUpdate.htm?ddoCode=${bgroup.ddoCode}" target='blank'>${bgroup.departmentname}(${bgroup.ddoCode})</a></td>
