                                                ...
                                                <div class="panel-heading">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <h4 style="color:  #0071c5;" align="center"><strong> <u>DDO Wise Men In Position Report Details of <c:out value="${officename}"/></strong></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <table class="table table-bordered table-hover table-striped">
                                                                ...
                                                                <c:forEach items="${AERDetails}" var="bgroup" varStatus="count">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="ViewDDODeptWiseMIPPostList.htm?postgroup=A&parttype=A&aerId=${bgroup.aerId}&offcode=${bgroup.offCode}" target="_blank">${bgroup.totalACnt}</a>
                                                                        </td>
                                                                        <td>
                                                                            <a href="ViewDDODeptWiseMIPPostList.htm?postgroup=B&parttype=A&aerId=${bgroup.aerId}&offcode=${bgroup.offCode}" target="_blank">${bgroup.totalBCnt}</a>
                                                                        </td>
                                                                        <td>
                                                                            <a href="ViewDDODeptWiseMIPPostList.htm?postgroup=C&parttype=A&aerId=${bgroup.aerId}&offcode=${bgroup.offCode}" target="_blank">${bgroup.totalCCnt}</a>
                                                                        </td>
                                                                        <td>
                                                                            <a href="ViewDDODeptWiseMIPPostList.htm?postgroup=D&parttype=A&aerId=${bgroup.aerId}&offcode=${bgroup.offCode}" target="_blank">${bgroup.totalDCnt}</a>
                                                                        </td>
