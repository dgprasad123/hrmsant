            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" align="center" style="background-color: #868686;color: #ffffff;font-size: xx-large;">DDO Wise AER Updation  Report(Fy:2023-24)</div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <c:forEach items="${AERDetails}" var="bgroup" varStatus="count">
                                            ...
                                            <tr>
                                                <td>${count.index + 1}</td>
                                                <td><a href="#" target='blank'>${bgroup.departmentname}</a> <b>(${bgroup.offCode})</b></td>
