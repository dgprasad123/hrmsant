                                        ...
                                        <div class="container-fluid" style="padding-top: 125px;padding-bottom: 125px;">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <h2 style="color:  #0071c5;text-transform: uppercase" align="center" > Annual Establishment Review</h2>
                                                            <h4 style="color:  #0071c5;text-transform: uppercase" align="center"><strong> <u>CO Wise MEN-IN-POSITION (Both Plan & Non-Plan) Report Details of <c:out value="${deptname}"/></strong></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <table class="table table-bordered table-hover table-striped">
                                                                ...
                                                                <c:forEach items="${AERDetails}" var="bgroup" varStatus="count">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href="viewDDODeptWiseMIP.htm?offCode=${bgroup.offCode}&aerId=${bgroup.aerId}" target="_blank">${bgroup.offName}</a>
                                                                        </td>
