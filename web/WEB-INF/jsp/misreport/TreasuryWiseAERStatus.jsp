            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading" align="center" style="background-color: #868686;color: #ffffff;font-size: xx-large;">Treasury Wise AER Report(Fy:<c:out value="${fiscalyear}"/>) </div>
                        ...
                        <div class="panel-body">
                            <div style="margin-bottom: 10px;">
                                <form:form action="TreasuryWiseAERStatus.htm" method="POST" commandName="command">
                                    <div class="row">
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <c:set var="Gtotaloff" value="${0}" />

                                        <c:forEach items="${AERDetails}" var="bgroup" varStatus="count">

                                            <c:set var="GtotalEmp" value="${GtotalEmp + bgroup.totalDDO}" />
                                            <c:set var="Gtotaloff" value="${Gtotaloff + bgroup.totalOffice}" />
                                            <tr>
                                                <td>${count.index + 1}</td>
                                                <td><a href="TreasuryWiseOfficeAERReport.htm?trCode=${bgroup.trCode}" target="_blank">${bgroup.trName}</a></td>
                                                <td><a href="TreasuryWiseOfficeAERReport.htm?trCode=${bgroup.trCode}" target="_blank">${bgroup.trCode}</a></td>                                            
                                                <td>${bgroup.totalDDO}</td>
                                                <td>${bgroup.totalOffice}</td>
