                ...
                <div align="center">
                    <table border="0" cellspacing="0" cellpadding="0" style="width:100%">
                        <tr style="height:40px">
                            ...
                            <td width="70%">
                                <input name="hidDeptCode" id="deptname" class="easyui-combobox" style="width:500px;" data-options="valueField:'deptCode',textField:'deptName',editable:true" />
                            </td>
                            <td width="15%">
                                &nbsp;
                            </td>
                        ...
                        <tr style="height:40px">
                            ...
                            <td>
                                <input name="hidOffCode" id="officename" class="easyui-combobox" style="width:500px;" data-options="valueField:'offCode',textField:'offName',editable:true"/>
                            </td>
                            <td>
