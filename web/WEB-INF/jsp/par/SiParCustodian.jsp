    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function populateDataInGrid(parlist) {
                ...
                for (var i = 0; i < parlist.length; i++) {
                    var row = '<tr>' +
                            ...
                            '<td><a href="SiParDataCustodianView.htm?empId=' + parlist[i].empId + '&fiscalyear=' + $("#fiscalyear").val() + '&encParId=' + parlist[i].encParId + '">View</a></td>' +
            ...
            function confirmDownload() {
                ...
                if (fiscalyear) {
                    window.location = "downloadSiParCustodian.htm?fiscalyear=" + fiscalyear;
                }
            }
        ...
        <div id="page-wrapper">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 style="text-align:center">List of PAR for SI & Equivalent Ranks (Group - B) </h3>
                </div>
