...
<html>
    <head>
        ...
        <div id="wrapper"> 
            ...
            <form:form id="siParForm" action="viewSiPARAdmin.htm" method="post" commandName="ParAdminSearchCriteria">
                <div id="page-wrapper">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 style="text-align:center">Total PAR(SI) Details</h3>
                        </div>
                        ...
                        <div class="panel-body" style="border-bottom: 2px solid #A6ECD9;">
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-2" align="right">
                                    <label> Select Fiscal Year <span style="color: red">*</span></label>
                                </div>
                                <div class="col-lg-3">
                                ...
                                <div class="btn-group col-lg-2"> &nbsp; </div>
                            </div>
                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> 
                                                            <c:if test="${eachPar.parstatus ne 'REQUESTED FOR NRC'}">
                                                                <a href="ParAdminSiView.htm?empId=${eachPar.empId}&fiscalyear=${eachPar.fiscalyear}&encParId=${eachPar.encParId}" style="color:#FF4500;"> View </a>
                                                            </c:if>
                                                        </td>
                                                    </tr>
                                                </c:forEach>      
