<%-- 
    Document   : ParAdverseRemarkReply
    Created on : 13 Aug, 2020, 4:21:56 PM
    Author     : Manisha
--%>
...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <form:form action="parAdverseCommunicationReply.htm" method="POST" commandName="parAdverseCommunicationDetail" class="form-horizontal" enctype="multipart/form-data">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="height: 200px;overflow: auto;">
                        ...
                        <c:if test="${parAdverseCommunicationDetail.adverseCommunicationStatusId eq 101}">
                              <div class="form-group">
                        ...
                        <c:if test="${parAdverseCommunicationDetail.adverseCommunicationStatusId eq 103}">
                              <div class="form-group">
