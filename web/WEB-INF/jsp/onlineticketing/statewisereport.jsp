...
<html>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <form:form action="GetStateMISReport.htm" commandName="onlineticketing">
                    <div class="container-fluid">
                        <div class="panel panel-primary">
                            <div class="panel-heading">Online Support Ticket Report(State Team)</div>
                            <div class="panel-body" style="margin-top:20px;">
                                ...
                                <h2 align="center">Online Support Ticket Report(State Team)</h2>
                                <table id="example" class="table table-striped table-bordered" width="100%" cellspacing="0" style='margin-top:10px'>
                                    <tr>
                                        ...
                                        <th >Ticket is Inprogress During the month</th>
                                    </tr>
