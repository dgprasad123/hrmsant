...
<html>
    ...
    <body>
        ...
        <form:form action="SaveonlineticketDc.htm" commandName="onlineticketing" enctype="multipart/form-data" onsubmit="return validate();">
            ...
            <input type='hidden' name='userType' value='HRMS Employee'/>
            <!--<input type='hidden' name='username' value='${loginName}'/>-->
            <div class="container">
                <c:if test = "${onlineticketlist[0].status != 'Closed'}">
                    <button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo" style='width:100%;text-align:left'><strong >Reply Ticket Id (<c:out value="${onlineticketlist[0].topicName}" />) :&nbsp;<c:out value="${onlineticketlist[0].fticketid}" /></strong> &nbsp;<i>(Please click Here)</i></button>
                <div>&nbsp;</div>
                 </c:if>
                        ...
                        <div class="row "  >
                            <div class="col-md-4 col-md-push-4">
                                ...
                                <form:select path="status" class="form-control" id='status'>
                                    ...
                                    <form:option value="Reopened" label="Reopen"/> 
