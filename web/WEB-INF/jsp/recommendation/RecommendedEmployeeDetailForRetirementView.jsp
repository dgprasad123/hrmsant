    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function validateForm() {
                if ($("#overallviews").val() == "") {
                    alert("Please Enter Why premature retirement is recommended");
                    $("#overallviews").focus();
                    return false;
                }
            }
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <c:if test="${empty recommendationDetailBean.submittedondate}">
                                    <form:textarea class="form-control" path="reasonforrecommendation" maxlength="500"/>
                        ...
                        <c:if test="${empty recommendationDetailBean.isApproved}"> 
                            <div class="form-group" id ="remarksdiv">
                                <label class="control-label col-sm-3">Overall views on why premature retirement is recommended<span style="color: red">*</span></label>

                                <div class="col-sm-7"> 
                                    <form:textarea class="form-control" path="overallviews" maxlength="200"/>                                
                                    <span style="font-size: 12px;color: red;">(Not more than 200 Words)</span>
                                </div>
                                <div class="form-group row">
                                    <label for="fa" class="col-sm-2 col-form-label">Document (if any) <span style="font-size: x-small;color: red;">(Max 20 MB)</span></label>
                        ...
                        <c:if test="${recommendationDetailBean.isApproved eq 'Y'}">
                            <div class="form-group">
                                <label class="control-label col-sm-3" >Overall views on why premature retirement is recommended</label>
