        ...
        <script type="text/javascript">
            ...
            function getDeptWiseOfficeList(type) {
                ...
                $.getJSON(url, function(data) {
                    ...
                    if (type == "A") {
                        $('#authOfficeCode').val('${Resignation.authOfficeCode}');
                        getOfficeWisePostList('A');
                    } else if (type == "R") {
                        $('#retiredfromofficeCode').val('${Resignation.retiredfromofficeCode}');
                ...
                $.getJSON(url, function(data) {
                    $.each(data, function(i, obj) {
                        if (type == "A") {
                            ...
                            $('#authSpc').val('${Resignation.authSpc}');
                        } else if (type == "R") {
                            if (transactionStatus == "S") {
        ...
        <div class="col-md-8 col-sm-8" style="margin-top: 10px;">
            <div class="panel panel-default">
                <div class="panel-body">
                    <form:form class="form-horizontal" action="SaveEmployeeResignation.htm" commandName="Resignation" method="post">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" style="padding-top: 0px;">Type of Resignation:</label>
                            <span class="col-sm-10">
                                <form:select path="regtype" class="form-control">
                                    <form:option value="RG">RESIGNATION</form:option>
                                </form:select> 
                            </span>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" style="padding-top: 0px;">Resigned From:</label>
                        ...
                        <div class="form-group">
                            ...
                            <span class="col-sm-10">
                                <c:if test="${Resignation.hidnotid gt 0}">
                                    <c:out value="${Resignation.retdDeptName}"/>
                                    <form:hidden path="retiredfromdeptCode"/>
                                </c:if>
                                <c:if test="${Resignation.hidnotid eq 0}">
                                    <form:select path="retiredfromdeptCode" class="form-control" onchange="getDeptWiseOfficeList('R');">
                                        <form:option value="">--Select One--</form:option>
                                        <form:options items="${departmentlist}" itemLabel="deptName" itemValue="deptCode"/>
                                    </form:select>
                                </c:if>
                        ...
                        <div class="form-group">
                            ...
                            <span class="col-sm-10">
                                ...
                                <c:if test="${Resignation.hidnotid gt 0}">
                                    <c:out value="${Resignation.retdoffName}"/>
                                    <form:hidden path="retiredfromofficeCode"/>
                                </c:if>
                                <c:if test="${Resignation.hidnotid eq 0}">
                                    <form:select path="retiredfromofficeCode" class="form-control" onchange="getOfficeWisePostList('R');">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-2" style="padding-top: 0px;">(c)Resignation Post <span style="color: red">*</span>:</label>
                            <span class="col-sm-10">
                                <c:if test="${Resignation.hidnotid gt 0}">
                                    <c:out value="${Resignation.retdPostName}"/>
                                    <form:hidden path="retiredfromspc"/>
                                </c:if>
                                <c:if test="${Resignation.hidnotid eq 0}">
                        ...
                        <div class="form-group">                                                         
                            <label class="control-label col-sm-2" style="padding-top: 0px;">Date of Resignation<span style="color: red">*</span>:</label>
                            <span class="col-sm-1">
                        ...
                        <%--<c:if test="${not empty Resignation.retid}">--%> 
                        ...
                        <input type="submit" name="action" value="Back" class="btn btn-primary" onclick="return back();"/>
                    </form:form>
                </div>
            </div>
        </div>
