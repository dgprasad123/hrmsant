...
<html>
    ...
    <body>
        <form:form action="savePromotionSBCorrection.htm" method="POST" commandName="promotionForm">
            <div class="container-fluid">
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer">
                        <c:if test="${mode eq 'E'}">
                            <input type="submit" name="btnPromotion" value="Save" class="btn btn-success" onclick="return saveCheck();"/>
                            <input type="submit" name="btnPromotion" value="Submit" class="btn btn-default" onclick="return confirm('Are you sure to submit?');"/>
                        </c:if>
                        <c:if test="${mode eq 'D'}">
                            <input type="submit" name="btnPromotion" value="Approve" class="btn btn-success" onclick="return approveCheck();"/>
                        </c:if>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" onclick="closeInnerModal('promotionAuthorityModal')">Close</button>
                        </div>
                    </div>
                </div>
            </div>                
            ...
            <div id="promotionPostingModal" class="modal" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" onclick="closeInnerModal('promotionPostingModal')">Close</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="promotionNotifyingAuthorityOtherOrgModal" class="modal" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" onclick="closeInnerModal('promotionNotifyingAuthorityOtherOrgModal')">Close</button>
                        </div>
                    </div>
                </div>
            </div>
            <div id="promotionOtherOrgModal" class="modal" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" onclick="closeInnerModal('promotionOtherOrgModal')">Close</button>
                        </div>
                    </div>
                </div>
            </div>
