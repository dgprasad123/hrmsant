        ...
        <div class="col-md-8 col-sm-8" style="margin-top: 10px;">
            <div class="panel panel-default">
                <div class="panel-body">
                    <form:form class="form-horizontal" action="SaveEmployeeReAppointment.htm" commandName="reAppointmentForm" method="post">
                        <form:hidden path="reappointmentid"/>
                        ...
                        <div class="form-group">
                            ...
                            <span class="col-sm-10">
                                <form:select path="authSpc" id="authSpc" class="form-control">
                                    <form:option value="">--Select One--</form:option>
                                    <form:options items="${postlist}" itemLabel="postname" itemValue="spc"/>
                                </form:select> 
                            </span>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" style="padding-top: 0px;">Type:</label>
                            <span class="col-sm-10">
                                <form:select path="regtype" class="form-control">
                                    <form:option value="RP">REAPPOINTMENT</form:option>
                                </form:select> 
                            </span>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-2" style="padding-top: 0px;">Reappointed From:</label>
                            <span class="col-sm-3">
                                <form:select path="reappointedFromPost" class="form-control">
                                    <c:if test="${not empty reAppointmentForm.reappointedFromPost}">
                                        <form:option value="${reAppointmentForm.reappointedFromPost}">${reAppointmentForm.reappointedFromPostName}</form:option>
                                    </c:if>
                                    <c:if test="${empty reAppointmentForm.reappointedFromPost}">
                                        <form:option value="${employee.spc}">${employee.post}</form:option>
                                    </c:if>
                                </form:select>
                            </span>
                        </div>
                        ...
                        <div class="form-group">                                                         
                            <label class="control-label col-sm-2" style="padding-top: 0px;">Date of Reappointment<span style="color: red">*</span>:</label>
                            <div class="col-sm-2 input-group date">
                        ...
                        <c:if test="${empty reAppointmentForm.reappointmentid}">
                            <input type="submit" name="action" value="Save" class="btn btn-primary" onclick="return savecheck();"/>
                        </c:if>
                        <c:if test="${not empty reAppointmentForm.reappointmentid}">
