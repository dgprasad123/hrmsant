...
<html>
    ...
    <body>
        <form:form action="SaveLoanSanctionSBCorrection.htm" method="post" commandName="command" id="loanform">
                            ...
                            <div class="col-lg-12">
                                <table width="100%">                                
                                    <tr>                                    
                                        ...
                                        <td><label>Total No of Instl</label></td>
                                        <td><label>Instalment Amount</label></td>
                                        <td><label>Paid Instl No</label></td>
                                        <td><label>Monthly Instl No(if required)</label></td>
                                    ...
                                    <tr>                                    
                                        ...
                                        <td><form:checkbox path="completedRecoverySBCorrection" class="form-control" value="1" id="completedRecoverySBCorrection"/></td>
                                    </tr>                                
                                </table>
                            </div>
                        </div>
