...
<html>
    ...
    <body>
        <form:form action="saveRoabsence.htm" method="post" commandName="RoabsenceBean">
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <strong style="font-size:14pt;">Employee Regularization of Absence</strong>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            <div class="col-lg-2">
                                <label for="duration" style="font-size:14pt;">Period of Absence:</label>
                            </div>
                        </div>
                    ...
                    <div class="panel-footer">
                        <button type="submit" name="submit" value="Save" class="btn btn-default" onclick="return saveCheck();">Save Regularization of Absence</button>
                        ...
                        <input type="button" value="Cancel" class="btn btn-default" onclick="self.location = 'RoabsenceList.htm'" />
                    </div>
                </div>
            </div>
