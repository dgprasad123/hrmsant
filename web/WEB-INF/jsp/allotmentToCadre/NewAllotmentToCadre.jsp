...
<html>
    ...
    <body>
        <form:form action="saveAllotmentToCadre.htm" method="POST" commandName="allotmentToCadreForm">
            <div class="container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Employee Allotment To Cadre
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-bottom: 7px;">
                            ...
                            <div class="col-lg-1">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#allotmentToCadreAuthorityModal">
                    ...
                    <div class="panel-footer">
                        <input type="submit" name="btnAllotmentToCadre" value="Save" class="btn btn-default" onclick="return saveCheck();"/>
                        <c:if test="${not empty promotionForm.promotionId}">
                            <input type="button" name="btnAllotmentToCadre" value="Delete" class="btn btn-default" onclick="return confirm('Are you sure to delete?');"/>
                        </c:if>
                    </div>
                </div>
            </div>

            <div id="allotmentToCadreAuthorityModal" class="modal" role="dialog">
