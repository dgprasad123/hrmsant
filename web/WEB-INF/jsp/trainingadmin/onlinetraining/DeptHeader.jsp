...
<div id="left_container">
    <div style="border-bottom:1px solid #1A2734;margin-top:10px;padding:5px 0px;"><br />
        <table width="100%" style="border:0px;">
            ...
            <span style="font-size:10pt;font-weight:bold;text-transform:uppercase;color:#FFFFFF;">${fullName} Department</span></td>
            </tr>
        </table>
        </div>
    <div style="border-top:1px solid #3B5A7C;font-size:10pt;padding-top:5px;">
        <ul style="">
            ...
            <li><a href="DeptOnlineInstitutes.htm"<c:if  test = "${mnu=='INSTITUTES'}"> class="sel"</c:if>><img src="images/calendar.png" width="16" style="vertical-align:middle;" /> &nbsp;Online Institutes</a></li>
