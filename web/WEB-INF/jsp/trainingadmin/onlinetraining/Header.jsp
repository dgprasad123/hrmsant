...
<div id="left_container">
    <div style="border-bottom:1px solid #1A2734;margin-top:10px;padding:5px 0px;"><br />
    ...
    <div style="border-top:1px solid #3B5A7C;font-size:10pt;padding-top:5px;">
        <ul style="">
            <c:set var="mnu" scope="session" value='<%=request.getParameter("menuHighlight")%>'/>
              <li><a href="EmployeeAttendance.htm"><img src="images/calendar.png" width="16" style="vertical-align:middle;" /> &nbsp;Attendance Details</a></li>
            <li><a href="OnlineInstitutes.htm"<c:if  test = "${mnu=='INSTITUTES'}"> class="sel"</c:if>><img src="images/calendar.png" width="16" style="vertical-align:middle;" /> &nbsp;Online Institutes</a></li>
            <li><a href="OnlineApplications.htm"<c:if  test = "${mnu=='APPLICATIONS'}"> class="sel"</c:if>><img src="images/faculty.png" width="16" style="vertical-align:middle;" /> &nbsp;Online Applications</a></li>
            <li><a href="logout.htm"><img src="images/logout.png" width="16" style="vertical-align:middle;" /> &nbsp;Logout</a></li>
        </ul>
    </div>
</div>
<div style="float:left;width:82%;background:#FFFFFF;">
