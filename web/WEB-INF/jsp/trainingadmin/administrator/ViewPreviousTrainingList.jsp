...
<html>
    <head>
        ...
        <title>Previous Training List</title>
        ...
        <script type="text/javascript">
            function searchEmployee()
            {
                ...
                $.ajax({
                  url: 'SearchPreviousTraining.htm',
                  type: 'get',
    ...
    <body>
        ...
        <div style="width:90%;margin:0px auto;"><h1 style="font-size:18pt;margin:0px;">Search Training for Employee</h1></div>
                <form:form class="form-control-inline"  action="SearchPreviousTraining.htm" method="POST" commandName="EmployeeSearch">
