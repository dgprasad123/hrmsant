...
<html>
    ...
    <body>
         <jsp:include page="Header.jsp">
            <jsp:param name="menuHighlight" value="PREVIOUS_TRAINING" />
        </jsp:include>
        <div style="width:100%;margin:0px auto;"><h1 style="font-size:18pt;margin:0px;margin-bottom:10px;">Previous Training</h1>
            <p style='margin-top:10px 0px;'><input type="button" value="&laquo; Back to Active Training List" class="btn btn-primary btn-md" onclick="self.location='TAManageTrainingDetail.htm?trainingId=${trainingId}'" /></p>
        </div>
