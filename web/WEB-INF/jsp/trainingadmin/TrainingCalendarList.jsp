        ...
        <jsp:include page="Header.jsp">
            <jsp:param name="menuHighlight" value="CALENDAR" />
                    ...
                    <table id="dg" class="easyui-datagrid" style="width:100%;height:400px;" title="Training Calendar" 
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-options="field:'viewDetail',width:'3%',formatter:manageBatch" align='center'></th>
                ...
                <script type="text/javascript">
                    ...
                    function manageBatch(val, row)
                    {
                        str1 = '<a href="ManageBatch.htm?trainingId=' + row.trainingProgramID +'" title="Manage Batch"><img src="images/batch_icon.png" alt="Manage Batch" width="18" /></a>';
                        return str1;
                    }                    
