<%-- 
    Document   : SearchEmployeeAG
    Created on : Nov 11, 2019, 3:13:20 PM
    Author     : manisha
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                /*var url = ' getAGTreasuryListJSON.htm?deptCode=' + this.value;
                 $.getJSON(url, function (result) {
                 $.each(result, function (i, field) {
                 $('#TreasuryCode').append($('<option>', {
                 value: field.TreasuryCode,
                 text: field.TreasuryName
                 }));
                 });
                 });
                 });*/
            ...
            function searchEmployee() {
                ...
                $.post("SearchEmployeeAGInfoJson.htm", {deptName: deptName, offcode: offcode, agtreasurycode: agtreasurycode, year: year, Criteria: Criteria, searchString: searchString, page: 1, rows: rowSize})
                        .done(function (data) {
                ...
                for (var i = 0; i < employeelist.length; i++) {
                    ...
                    if (employeelist[i].hasPriv == 'Y') {
                        ...
                        if (employeelist[i].ddohrmsid != '') {
                            row = row + '<td style="color: white ; background: green">' + employeelist[i].empName + '<br>' + handleUndefind(employeelist[i].post) + '</td>';
                        ...
                        row = row + '<td style="color: #fff !important; "><a href="javascript:void(0);" style="color: #0000FF !important; " data-href="EmployeeBasicProfile.htm?empid=' + employeelist[i].empid + ' " class="openPopup">View</a></td>';
                        row = row + '<td style="color: #fff !important; "><a href="PoliceServiceBook.htm?empid=' + employeelist[i].empid + '" target="_blank" style="color: #0000FF !important; ">Service Book</a></td>';
                        row = row + '<td style="color: #fff !important; "><a href="newMessage.htm?empid=' + employeelist[i].empid + '" style="color: #0000FF !important; ">Message</a></td>';
                        row = row + '</tr>';
                        ...
                        <form:form action="SearchEmployeeInfo.htm" commandName="searchEmployee" method="post">
                            <div class="container-fluid" style="margin-top: 30px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <form:select class="form-control" path="Criteria" id="Criteria">
                                            ...
                                            <form:option value="FNAME">FIRST NAME (like)</form:option>
                                        </form:select>
                                    </div>
                                ...
                                <div class="row" style="margin-top:10px; margin-bottom: 20px;">
                                    <div class="col-sm-2">
                                        <input type="button" class="btn btn-info" value="Search" id="searchbtn" onclick="return searchEmployee()"/>
                                    </div>
                                </div>
                            </div> 
