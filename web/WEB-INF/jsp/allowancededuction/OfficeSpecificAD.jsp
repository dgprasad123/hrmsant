            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <form:form class="form-inline" action="officeWiseUpdatedADAction.htm" method="POST" commandName="command">
                        ...
                        <tbody>
                            <c:forEach items="${adlist}" var="ad" varStatus="cnt">
                                <tr>
                                    ...
                                    <td>${ad.formula}</td>
                                    <td>${ad.advalue}</td>
                                    <td><a href="officeAllowanceAndDeductionEdit.htm?adcode=${ad.refadcode}&adtype=${ad.adtype}&whereupdated=${ad.whereupdated}">Edit</a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
