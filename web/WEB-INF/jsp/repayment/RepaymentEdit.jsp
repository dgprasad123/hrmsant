...
<html>
    <head>
        ...
        <title>Loan Repayment Data</title>
        ...
        <form:form id="fm" action="loanrepayment.htm" method="post" name="myForm" commandName="loanrepayment">
            <div class="container-fluid">
                <div class="panel panel-default">
                    ...
                    <div class="row" style="margin-bottom: 7px;">
                        <div class="col-lg-2">
                            <label for="txtNotOrdNo">Repayment Type<span style="color: red">*</span></label>
                        </div>
                        <div class="col-lg-2">   
                    ...
                    <div class="row" style="margin-bottom: 7px;">
                        <div class="col-lg-2">
                            <label for="txtNotOrdNo">Repayment Amount<span style="color: red">*</span></label>
                        </div>
                        <div class="col-lg-2">   
