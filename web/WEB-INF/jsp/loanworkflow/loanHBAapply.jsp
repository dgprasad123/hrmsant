        ...
        <script type="text/javascript">
             ...
             function applyloan()
            {
               var jobtype=$("#jobtype").val();
                if ( jobtype == "") {
                    alert("Please Enter Job Type the length of service rendered under the Government ");
                    document.getElementById("jobtype").focus();
                    return false;
                }
                var per_post=$("#per_post").val();
                if ( per_post == "") {
                    alert("Permanent Post,if any, and the name of office and Department Concerned ");
                    document.getElementById("per_post").focus();
                    return false;
                }
                var per_appointment=$("#per_appointment").val();
                if ( per_appointment == "") {
                    alert("Do you hold a permanent appointment under the Central Govt or any other state Govt if so, give particulars ");
                    document.getElementById("per_appointment").focus();
                    return false;
                }
                
                var other_govt_ser=$("#other_govt_ser").val();
                if ( other_govt_ser == "") {
                    alert("If your wife/husband a Govt servant If so, give her name, designation etc ");
                    document.getElementById("other_govt_ser").focus();
                    return false;
                } 
                   ...
                   <a href="#part1" class="btn btn-info" data-toggle="collapse" style="width:100%;text-align:left">3.Please State Job Type Details:</a>
                    <table style="width:100%" id="part1" class="collapse">  
                        <tr>
                            ...
                            <td style="width:60%"> 
                                <textarea cols="50" rows="1" name="jobtype" id="jobtype" ></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>&nbsp;</td>
