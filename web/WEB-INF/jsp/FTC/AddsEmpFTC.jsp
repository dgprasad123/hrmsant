...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function closePostingOtherOrgModal() {
                $("#ltcOtherOrgModal").modal('hide');

                $('#notifyingSpc').val($('#hidOthSpc option:selected').text());
            ...
            function getPost(type) {
                ...
                $("#deputationAuthorityModal").modal('hide');
    ...
    <body>
        <div>
            <form:form action="savesFTCEntry.htm" method="post" commandName="sFTCBean">
                ...
                <div class="container-fluid">
                    <div class="panel panel-default">
                        <div class="panel-heading" style="color:#1C6CB7;font-weight:bold;font-size:14pt;">
                            Employee Free Travel Concession
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="row" style="margin-bottom: 7px;">
                                ...
                                <div class="col-lg-1">
                                    <button type="button" class="btn btn-primary" onclick="openLTCModal();">
                        ...
                        <div class="panel-footer">
                            <input type="submit" name="action" value="Save FTC" class="btn btn-default" onclick="return saveCheck();"/>
                            <input type="submit" name="action" value="Back to FTC List" class="btn btn-default"/>
                        </div>
                    </div>
                </div>
                ...
                <div id="ltcOtherOrgModal" class="modal" role="dialog">
                    <div class="modal-dialog">
                        <!-- Modal content-->
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">Notifying Details</h4>
                            </div>
                            <div class="modal-body">
                                <div class="row" style="margin-bottom: 7px;">
                                    <div class="col-lg-2">
                                        <label for="hidOthSpc">Notifying Authority</label>
                                    </div>
                                    <div class="col-lg-9">
                                        <form:select path="hidOthSpc" id="hidOthSpc" class="form-control">
                                            <form:option value="">--Select Post--</form:option>
