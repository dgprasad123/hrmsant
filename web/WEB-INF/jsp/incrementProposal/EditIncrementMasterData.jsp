            ...
            <div class="container-fluid">
                <div class="panel panel-default">
                                ...
                                <c:forEach items="${EmpList}" var="list" varStatus="counter">
                                    <tr>
                                        ...
                                        <td><select name="payCommission" id="pay_commission_${list.empId}" size="1" onchange="javascript: getFuturePay('${list.empId}', ${list.presentpay})">
                                                ...
                                                <option value="7"<c:if test = "${list.payCommission eq '7'}"> selected="selected"</c:if>>7th</option>
                                                <option value="6"<c:if test = "${list.payCommission eq '6'}"> selected="selected"</c:if>>6th</option>
                                                </select></td>
                                        ...
                                        <td><a href="javascript:void(0)" onclick="javascript: deleteEmp('${list.empId}', '${list.proposaldetailId}')">Remove</a></td>
                                    </tr>
                                </c:forEach>
                    ...
                    <div class="panel-footer">
                        <input type="submit" name="action" class="btn btn-default" value="Add Employees"/>
                        <input type="submit" name="action" class="btn btn-default" value="Save Proposal" onclick="return validateSubmit()"/>
