...
@Repository
@Scope("singleton")
public class MaxPromotionIdDAOImpl implements MaxPromotionIdDAO{
    ...
    @Override
    public String getMaxPromotionId() {
        Statement st = null;
        ResultSet rs = null;
        ...
        try {
            if (mCode != null) {
                ...
                rs = st.executeQuery("SELECT MAX(cast ( pro_id as BIGINT )) MCODE FROM emp_promotion");
                if (rs.next()) {
