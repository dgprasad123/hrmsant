...
@Repository
@Scope("singleton")
public class MaxSuspensionIdDAOImpl implements MaxSuspensionIdDAO{
    ...
    @Override
    public String getMaxSuspensionId() {
        Statement st = null;
        ResultSet rs = null;
        ...
        try {
            if (mCode != null) {
                ...
                rs = st.executeQuery("SELECT MAX(cast ( sp_id as BIGINT )) MCODE FROM emp_suspension");
                if (rs.next()) {
