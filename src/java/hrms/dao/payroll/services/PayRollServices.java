...
public class PayRollServices {
    ...
    private void printPageTotal(DMPUtil dmpUtil, ArrayList originalList, int pageno, int count, boolean isLastPage) throws Exception {
        ...
        dmpUtil.writeToFile(StringUtils.rightPad("", 4) + StringUtils.leftPad("", 20) + " " + StringUtils.leftPad("", 20) + StringUtils.leftPad(AqFunctionalities.getColTotal(originalList, end, "col6", 3, null) + "", 6) + " "
                ...
                + StringUtils.leftPad(AqFunctionalities.getColTotal(originalList, end, "col17", 3, null) + "", 11) + " "
    ...
    private void grandTotal(DMPUtil dmpUtil, ArrayList originalList, int pageno) throws Exception {
        ...
        dmpUtil.writeToFile(StringUtils.rightPad("", 4) + fstRowCaption + " "
                ...
                + StringUtils.leftPad(AqFunctionalities.getColGrandTotal(originalList, "col16", "PA", null) + AqFunctionalities.getColGrandTotal(originalList, "col16", "MAL", null) + AqFunctionalities.getColGrandTotal(originalList, "col16", "TRDA", null) + AqFunctionalities.getColGrandTotal(originalList, "col16", "OVDL", "P") + "", 11) +" "
                + StringUtils.leftPad(AqFunctionalities.getColGrandTotal(originalList, "col17", 0, null) + AqFunctionalities.getColGrandTotal(originalList, "col17", 1, null) + AqFunctionalities.getColGrandTotal(originalList, "col17", 2, null) + + AqFunctionalities.getColGrandTotal(originalList, "col17", 3, null) + AqFunctionalities.getColGrandTotal(originalList, "col17", 4, null)+"", 10) + " "
    ...
    private void printPageGrandTotal(DMPUtil dmpUtil, ArrayList originalList, int totalRecord) throws Exception {
        ...
        dmpUtil.writeToFile(StringUtils.rightPad("", 4) + StringUtils.leftPad("", 20) + " " + StringUtils.leftPad("", 20) + StringUtils.leftPad(AqFunctionalities.getColGrandTotal(originalList, "col6", 3, null) + "", 6) + " "
                ...
                + StringUtils.leftPad(AqFunctionalities.getColGrandTotal(originalList, "col16", "OVDL", "P") + "", 13) + " "
                + StringUtils.leftPad(AqFunctionalities.getColGrandTotal(originalList, "col17", 3, null) + "", 11)
       );
        /*5TH ROW*/
    ...
    public File write(String billno, String folderPath, String fileSeparator, CommonReportParamBean crb) throws Exception {
                        ...
                        if (column10.size() > k) {
                            ...
                            if (k == 4) {
                                if (gpfsum == 0) {
                                    ...
                                    row5 = row5 + StringUtils.leftPad(" ", 23) + StringUtils.leftPad("", 6, "-") + StringUtils.leftPad("", 75);
                                }
                            }
                            if (k == 5) {
                                if (gpfsum == 0) {
        ...
        //originalList,"col3","BASIC",null)+""),6)
            ...
            dmpUtil.writeToFile(leftspace + "INC.TAX 7112(58816)= Rs" + StringUtils.rightPad(AqFunctionalities.getColGrandTotal(aqlist, "col11", "IT", null) + "", 9) + "GPF           8690(55545)=Rs" + StringUtils.rightPad((paybillDmpDao.getGPFAmount( billno, "8690",crb.getAqmonth(),crb.getAqyear())) + "", 9) + "  " + StringUtils.rightPad((paybillDmpDao.getGPFAmount(billno, "55545",crb.getAqmonth(),crb.getAqyear())) + "", 9));
            dmpUtil.writeToFile(leftspace + "                               " + "AISGPF       8692(57649)=Rs" + StringUtils.rightPad((paybillDmpDao.getGPFAmount(billno, "8692",crb.getAqmonth(),crb.getAqyear())) + "", 9) + "  " + StringUtils.rightPad((paybillDmpDao.getGPFAmount(billno, "57649",crb.getAqmonth(),crb.getAqyear())) + "", 9));
            ...
            dmpUtil.writeToFile(leftspace + "OVDL             = Rs" + StringUtils.rightPad(AqFunctionalities.getColGrandTotal(aqlist, "col16", "OVDL", "P") + "", 9));
            dmpUtil.writeToFile("");
            dmpUtil.writeToFile("");
