...
public class RepatriationForm {
    
    private String repatriationId = null;
    ...
    public String getRepatriationId() {
        return repatriationId;
    }

    public void setRepatriationId(String repatriationId) {
        this.repatriationId = repatriationId;
    }
