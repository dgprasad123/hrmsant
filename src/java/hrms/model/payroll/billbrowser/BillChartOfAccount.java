...
public class BillChartOfAccount {
    ...
    public String getDdoEmpName() {
        return ddoEmpName;
    }

    public void setDdoEmpName(String ddoEmpName) {
        this.ddoEmpName = ddoEmpName;
    }
