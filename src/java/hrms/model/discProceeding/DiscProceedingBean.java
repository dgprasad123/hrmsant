...
public class DiscProceedingBean {
    ...
    private String disciplinaryInitiatedOnDate;
...
//    
    ...
    public String getDisciplinaryInitiatedOnDate() {
        return disciplinaryInitiatedOnDate;
    }

    public void setDisciplinaryInitiatedOnDate(String disciplinaryInitiatedOnDate) {
        this.disciplinaryInitiatedOnDate = disciplinaryInitiatedOnDate;
    }
