package hrms.model.relieveCadre;

public class RelieveCadreForm {
    
    private String relieveCadreId;
    ...
    public String getRelieveCadreId() {
        return relieveCadreId;
    }

    public void setRelieveCadreId(String relieveCadreId) {
        this.relieveCadreId = relieveCadreId;
    }
