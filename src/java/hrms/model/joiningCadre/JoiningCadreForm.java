package hrms.model.joiningCadre;

public class JoiningCadreForm {
    
    private String joiningCadreId;
    ...
    private String sltPostGrp;
    
    public String getJoiningCadreId() {
        return joiningCadreId;
    }

    public void setJoiningCadreId(String joiningCadreId) {
        this.joiningCadreId = joiningCadreId;
    }
    ...
    public String getSltPostGrp() {
        return sltPostGrp;
    }

    public void setSltPostGrp(String sltPostGrp) {
        this.sltPostGrp = sltPostGrp;
    }      
}
