package hrms.model.licreport;

public class LICDivisionWiseBean {
    ...
    private String prmAdress;
    private String villageName;
    private String distName;
    private String prmPin;
    
    private String sltDivision;
    ...
    public String getPrmPin() {
        return prmPin;
    }

    public void setPrmPin(String prmPin) {
        this.prmPin = prmPin;
    }

    public String getSltDivision() {
        return sltDivision;
    }

    public void setSltDivision(String sltDivision) {
        this.sltDivision = sltDivision;
    }
